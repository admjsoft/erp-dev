var multi = (function () {
    ...
    var e = function (e, t, n) {
        ...
        if (!a.disabled) {
            var selectedId = a.value;

            // Call your custom function with the selected ID
            customFunction(selectedId)
                .then(function (result) {
                    if (result) {
                        // If the custom function returns true, update selected state
                        a.selected = !a.selected;

                        // Update the other list based on the selected state
                        if (a.selected) {
                ...
                .catch(function (error) {
                    // Handle the error from the custom function, if needed
                    console.error(error);
                });
        }
    };
    ...
    var t = function (e, t) {
        ...
        for (var d = null, r = null, l = 0; l < e.options.length; l++) {
            ...
            if (
                ((p.tabIndex = 0), (p.className = "item"), (p.innerText = c), p.setAttribute("role", "button"), p.setAttribute("data-value", o), p.setAttribute("multi-index", l), s.disabled && (p.className += " disabled"), s.selected)
            ) {
    ...
    return function (n, a) {
        if (
            (((a = void 0 !== a ? a : {}).enable_search = void 0 === a.enable_search || a.enable_search),
            (a.search_placeholder = void 0 !== a.search_placeholder ? a.search_placeholder : "Search..."),
            (a.non_selected_header = void 0 !== a.non_selected_header ? a.non_selected_header : null),
            (a.selected_header = void 0 !== a.selected_header ? a.selected_header : null),
            (a.limit = void 0 !== a.limit ? parseInt(a.limit) : -1),
            isNaN(a.limit) && (a.limit = -1),
            ...
            if (((i.className = "multi-wrapper"), a.enable_search)) {
                ...
                (d.className = "search-input"),
                    (d.type = "text"),
                    d.setAttribute("placeholder", a.search_placeholder),
