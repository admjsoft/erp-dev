...
unset($_SESSION['status']);unset($_SESSION['message']);
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-2">
            <div class="form-group">
              <label for="employee"><?php echo $this->lang->line('Invoice')." / ".$this->lang->line('DO No'); ?></label>
          ...
          <div class="col-md-2">
            <div class="form-group">
              <label for="employee"><?php echo $this->lang->line('Type'); ?></label>
              <select class="form-control" id="do_type">
                ...
                <option value="invoice"><?php echo $this->lang->line('Invoice DO'); ?></option>
                <option value="do"><?php echo $this->lang->line('Only Delivery Order'); ?></option>                
              </select>
            </div>
          </div>
    ...
    <div class="card card-block">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-8">
                <h4 class="card-title"><?php echo $this->lang->line('Delivery Orders For Customers') ?> </h4>
                </div>
                <div class="col-4 text-right">
                    <!-- Small Button -->
                    <a href="<?php echo base_url('deliveryorder/create_delivery_order'); ?>"> <button type="button" class="btn btn-sm btn-primary"><?php echo $this->lang->line('Create Delivery Order'); ?></button></a>
                </div>
            </div>
            ...
            <table id="doctable" class="table table-striped table-bordered zero-configuration" cellspacing="0"
                ...
                <tbody id="do_orders_list">
                    <?php if(!empty($do_orders)) { $ii=1; foreach($do_orders as $do_order){ ?>
                        ...
                        <td><a target="_blank" href="<?php echo base_url('invoices/view?id='.$do_order['invoice_id']); ?>" class="" ><?php echo $do_order['display_invoice_id']; ?></a></td>
                        ...
                        <td>
                            ...
                            <a href="<?php echo base_url('jobsheets/create/'.$do_order['do_id']); ?>" class="btn btn-info btn-sm" ><i class="fa fa-bus"></i> <?php echo $this->lang->line('Send to Delivery') ?></a> 
...
<div class="modal fade" id="do_return_details_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script type="text/javascript">
    ...
    $('#search').click(function () {
        ...
        $.ajax({
            type: 'POST',        
            dataType: 'json',
            url: '<?php echo base_url('deliveryorder/get_delivery_orders_list') ?>',
            data: { do_type: do_type, do_status: do_status, do_start_date: do_start_date,do_end_date : do_end_date,search_invoice_id : search_invoice_id  },
            success: function (response) {
    ...
    $.ajax({
            ...
            dataType: 'json',
            url: '<?php echo base_url('deliveryorder/get_delivery_orders_details') ?>',
            data: { do_id: do_id, do_type : do_type, do_option : '' },
            success: function (response) {
    ...
    $.ajax({
            ...
            dataType: 'json',
            url: '<?php echo base_url('deliveryorder/get_delivery_orders_details') ?>',
            data: { do_id: do_id, do_type : do_type, do_option : 'return'  },
            success: function (response) {
    ...
    $.ajax({
            ...
            dataType: 'json',
            url: '<?php echo base_url('deliveryorder/get_delivery_orders_details') ?>',
            data: { do_id: do_id, do_type : do_type, do_option : 'cancel'  },
            success: function (response) {
    ...
    $.ajax({
            ...
            data: { do_id: do_id, do_type : do_type, p_do_id : p_do_id  },
            success: function (response) {
    ...
    $(document).on('click', '.get_do_cancel_details', function() {
          ...
          Swal.fire({
                  icon: "error",
                  title: "Cancellation Not Allowed Once Items are Delivered. Please Contact Supplier",
                  showConfirmButton: false,
                  timer: 1500
                });
