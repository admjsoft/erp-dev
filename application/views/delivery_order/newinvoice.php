<div class="content-body">
    ...
    <div class="card">
        <div class="card-content">
            ...
            <script src="<?php echo base_url('application/third_party/tinymce/tinymce.min.js'); ?>"
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <div class="col-sm-6  text-left" id="cr_invoice_button_block" style="display:none">
                        <a id="cr_invoice_button" href="#"
                                class="btn btn-large btn-info mb-1 mt-2 float-left" title="Go Back"><span
                                    class="fa fa-reply"></span> <?php echo $this->lang->line('Go Back') ?> </a>

                                   
                        <a id="genearte_invoice_do" href="#" class="btn btn-warning mb-1 mt-2 ml-1" ><i
                                        class="fa fa-briefcase"> </i> <?php echo $this->lang->line('Generate DO'); ?>
                        </a>
                    </div>
                    <div class="col-sm-6 offset-sm-6 text-right"  id="cr_invoice_search_block">
                        <label class="float-left" for="autocomplete">Search Invoice ( Invoice Paid By Customers ) <span style="color:red">*</span></label>
                ...
                <div id="invoice_create_block">
                <form method="post" id="data_form" onSubmit="tinyMCE.triggerSave()">
                    <div class="row">
                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                    ...
                                    <div class="fcol-sm-12">
                                        <h3 class="title">
                                            <?php echo $this->lang->line('Bill To') ?> <a href='#'
                                                class="btn btn-primary btn-sm round ml-2" data-toggle="modal"
                                ...
                                <div id="customer">
                                    <div class="clientinfo">
                                        ...
                                        <hr>
                                        <div id="customer_company_name">
                                            <?php echo is_array($cust_details)?'<strong>'.$cust_details['company'].'</strong>':'';?>
                                        </div>
                                    </div>

                                    <div class="clientinfo">
                                        <input type="hidden" name="customer_id" id="customer_id"
                                            value="<?php echo is_array($cust_details)?$cust_details['id']:'0';?>">
                                        <div id="customer_name">
                                            <?php echo is_array($cust_details)?'<strong>'.$cust_details['name'].'</strong>':'';?>
                                        </div>

                                    </div>
                                    <div class="clientinfo">
                                        <div id="customer_address1">
                                            <?php echo is_array($cust_details)?'<strong>'.$cust_details['address'].'<br>'.$cust_details['city'].'</strong>':'';?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="clientinfo">
                                        ...
                                        <div id="customer_phone">
                                            <?php echo is_array($cust_details)?'Phone: <strong>'.$cust_details['phone'].'</strong>':'';?><br /><?php echo is_array($cust_details)?'Email: <strong>'.$cust_details['email'].'</strong>':'';?>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <?php  /* temprary hide echo $this->lang->line('Warehouse') ?> <select
                                        id="s_warehouses" class="form-control round">
                                    ...
                                    <div class="col-sm-6"><label for="invociedate"
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control round required"
                                                placeholder="Billing Date" name="invoicedate" data-toggle="datepicker"
                                                autocomplete="false">
                                        </div>
                                    </div>
                                    <div class="col-sm-6"><label for="invocieduedate"
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"><span class="icon-calendar-o"
                                                    aria-hidden="true"></span></div>
                                            <input type="text" class="form-control round required" name="invocieduedate"
                        ...
                        <table class="table-responsive tfr my_stripe">
                            ...
                            <thead>
                                <tr class="item_header bg-gradient-directional-blue white">
                                    <th width="30%" class="text-center"><?php echo $this->lang->line('Item Name') ?>
                                    </th>
                                    <th width="8%" class="text-center"><?php echo $this->lang->line('Quantity') ?></th>
                                    <th width="10%" class="text-center"><?php echo $this->lang->line('Rate') ?></th>
                                    <th width="10%" class="text-center"><?php echo $this->lang->line('Tax(%)') ?></th>
                                    <th width="10%" class="text-center"><?php echo $this->lang->line('Tax') ?></th>
                                    <th width="7%" class="text-center"><?php echo $this->lang->line('Discount') ?>(%)
                                    </th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control req amnt" name="product_qty[]"
                                            ...
                                            onkeyup="rowTotal('0'), billUpyog()" autocomplete="off" value="1"><input
                                    ...
                                    <td><input type="text" class="form-control vat " name="product_tax[]" id="vat-0"
                                            ...
                                            autocomplete="off"
                                            <?php if($system_data[0]['tax'] == 0){ echo "disabled"; } ?>></td>
                                ...
                                <tr>
                                    <td colspan="8">
                                        ...
                                        <textarea id="dpid-0" maxlength="110" class="form-control"
                                ...
                                ?><br>
                                        ...
                                        <select name="employee" class=" mt-1 col form-control form-control">
                                        ...
                                        foreach ($employee as $row) {
                                            ...
                                            }else if($this->aauth->get_user()->id==$row['id']){
                                                echo '<option value="' . $row['id'] . '">' . $row['name'] . ' (' . $row['name'] . ')</option>';
                                            }
                                        }?>
                                ...
                                <tr class="sub_c" style="display: table-row;">
                                    ...
                                    <td class="reverse_align" colspan="6"><input type="submit"
                                            ...
                                            value="<?php echo $this->lang->line('Generate DO') ?> " id="generate_invoice_btn"
                    ...
                    <input type="hidden" value="deliveryorder/action" id="action-url">
                    <input type="hidden" value="search" id="billtype">
                    <input type="hidden" value="0" name="counter" id="ganak">
                    <input type="hidden" value="<?php echo $system_data[0]['tax']; ?>" name="system_level_tax"
                        id="system_level_tax">
                    ...
                    <input type="hidden" value="<?php echo is_array($cust_details)?$cust_details['discount_c']:'0';?>"
                        id="custom_discount">

                </form>
                </div>
                <div id="invoice_details_block" style="display:none;">
                </div>    
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" placeholder="Phone" class="form-control margin-bottom"
                                        pattern="[0-9]*" inputmode="numeric" name="phone" id="mcustomer_phone">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label"
                                    for="email"><?php echo $this->lang->line('Email') ?> <span
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2"></div>
                                <div class="col-sm-5">
                                    <input type="text" placeholder="Company" class="form-control margin-bottom"
                                        name="company">
                                </div>

                                <div class="col-sm-5">
                                    <input type="text" placeholder="TAX ID" class="form-control margin-bottom"
                                        name="taxid" id="mcustomer_city">
                                </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" placeholder="Phone" pattern="[0-9]*" inputmode="numeric"
...
$("body").on("click", "#generate_invoice_btn", function(e) {
    var inv_id = $('#search_invoice_id').val();
    if(inv_id == '')
    {
        Swal.fire({
            icon: "error",
            title: "Invoice No is Mandatory",
...
$("body").on("input", "#search_invoice_id", function(e) {
    ...
    if (invoice_id) {       
        ...
        type: 'POST',        
        dataType: 'json',
        url: '<?php echo base_url('deliveryorder/get_invoice_details') ?>',
        data: { invoice_id: invoice_id  },
        success: function (response) {

            if(response.status == '200')
            {
                $('#cr_invoice_search_block').removeClass('offset-sm-6');
                $('#invoice_create_block').hide();
                $('#invoice_details_block').show();   
                $('#cr_invoice_button_block').show();             
                $('#invoice_details_block').html('');
                $('#invoice_details_block').html(response.html);
                //$('#genearte_invoice_do').

                var generateDOButton = document.getElementById('genearte_invoice_do');

                // Update the 'href' attribute with the dynamic ID value
                generateDOButton.href = "<?php echo base_url('deliveryorder/create_invoice_delivery_order?id='); ?>" + response.invoice_id;
...
$("body").on("click", "#cr_invoice_button", function(e) {
    
        $('#invoice_details_block').html(''); 
        $('#cr_invoice_button_block').hide();
        $('#invoice_create_block').show();         
        $('#cr_invoice_search_block').addClass('offset-sm-6');
        $('#cr_invoice_button_block').hide(); 
