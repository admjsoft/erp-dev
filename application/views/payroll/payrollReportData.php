     ...
     <table id="trans_table" class="table table-striped table-bordered zero-configuration" cellspacing="0"
                ...
                <thead>
                    <tr>
						...
						<th id="rp1"><?php echo $this->lang->line('Salary') ?></th>
                        <th id="rp2"><?php echo $this->lang->line('Allowance') ?></th>
					     <th id="rp3"><?php echo $this->lang->line('Commissions') ?></th>
					   <th id="rp4"><?php echo $this->lang->line('Claims') ?></th>
					    <th id="rp5"><?php echo $this->lang->line('Bonus') ?></th>
                        <th id="rp6"><?php echo $this->lang->line('OT') ?></th>
						<th id="rp7"><?php echo $this->lang->line('EPF') ?></th>
                        <th id="rp8"><?php echo $this->lang->line('SOCSO') ?></th>
                        <th id="rp9"><?php echo $this->lang->line('PCB') ?></th>
                        <th id="rp10"><?php echo $this->lang->line('Net Salary') ?></th>
                    </tr>
                </thead>
                <tbody>
        ...
        $('#trans_table').removeAttr('width').DataTable( {
           ...
           // scrollCollapse: true,
            ...
            "ajax": {
                ...
                "type": "POST",
                'data': {'timeCategory':<?php echo $timeCategory;?>,'staffid':<?php echo $staffid;?>,
				'salary':'<?php echo $salary;?>','allowance':'<?php echo $allowance;?>','commissions':'<?php echo $commissions;?>',
			'claims':'<?php echo $claims;?>','bonus':'<?php echo $bonus;?>','ot':'<?php echo $ot;?>',
				'epf':'<?php echo $claims;?>',	'socso':'<?php echo $socso;?>',	'pcb':'<?php echo $pcb;?>','dateMonth':<?php echo $dateMonth;?>,
