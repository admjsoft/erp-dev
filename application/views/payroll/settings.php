...
unset($_SESSION['status']);unset($_SESSION['message']);
                ...
                <form method="post" id="data_form" class="form-horizontal" onSubmit="return validate(event);"
                    ...
                    <div class="form-group row">
                        <label for="cst"
                            class="caption col-sm-2 col-form-label"><?php echo $this->lang->line('Basic Salary') ?><span
                    ...
                    <div id="customerpanel" class="form-group row">
                        <label for="toBizName"
                            class="caption col-sm-2 col-form-label"><?php echo $this->lang->line('EPF Employer') ?> %
                            <span style="color:red" id="err1">*</span></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label"
                            for="date"><?php echo $this->lang->line('EPF Employee') ?> % <span style="color:red"
                                id="err2">*</span></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label"
                            for="amount"><?php echo $this->lang->line('EPF Employee') ?> <span style="color:red"
                                id="err3">*</span></label>

                        <div class="col-sm-6">
                            <span class="epf_employee_error"></span>

                            <input type="text" placeholder="" class="form-control margin-bottom  required" name="epfEmp"
                                id="epfEmp" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">

                        <label class="col-sm-2 control-label"
                            for="product_price"><?php echo $this->lang->line('EPF Employer') ?> <span style="color:red"
                                id="err4">*</span></label>
                        <div class="col-sm-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" placeholder="" class="form-control margin-bottom  required"
                                    name="epfEmpyr" id="epfEmpyr" autocomplete="off">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label"><?php echo $this->lang->line('SOSCO Employer') ?> % 
...
<!-- 
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label"><?php echo $this->lang->line('SOCSO Employee') ?> % 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" placeholder="" class="form-control" autocomplete="off" name="socso"
                                id="socso">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label"><?php echo $this->lang->line('SOCSO Employee') ?>
                         <!-- <span style="color:red" id="err8">*</span>--></label> 

                        <div class="col-sm-6">
                            <span class="socsoEmp_error"></span>

                            <input type="text" placeholder="" class="form-control" name="socsoEmp" id="socsoEmp"
                                autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">

                        <label class="col-sm-2 col-form-label"><?php echo $this->lang->line('PCB') ?> <span
                                style="color:red" id="err9">*</span></label>

                        <div class="col-sm-6">
                            <span class="pcb_error"></span>

                            <input type="text" placeholder="" class="form-control" name="pcb" id="pcb"
                                autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">

                        <label class="col-sm-2 col-form-label"><?php echo $this->lang->line('EIS Employee') ?> <span
                                style="color:red" id="err10">*</span></label>

                        <div class="col-sm-6">
                            <span class="eis_error"></span>
                            <input type="text" placeholder="" class="form-control" name="eis" id="eis"
                                autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group row">

                        <label class="col-sm-2 col-form-label"><?php echo $this->lang->line('Bank Name') ?> <span
                                style="color:red">*</span></label>

                        <div class="col-sm-6">
                            <span class="bankName_error"></span>

                            <input type="text" placeholder="" class="form-control" name="bankName" id="bankName">
                        </div>
                    </div>
                    <div class="form-group row">

                        <label class="col-sm-2 col-form-label"><?php echo $this->lang->line('Bank Account No') ?> <span
                                style="color:red">*</span></label>

                        <div class="col-sm-6">
                            <span class="bankAcc_error"></span>

                            <input type="text" placeholder="" class="form-control" name="bankAcc" id="bankAcc">
                        </div>
                    </div>
                    <div class="form-group row">

                        <label class="col-sm-2 col-form-label"><?php echo $this->lang->line('Nationality') ?> <span
                                style="color:red">*</span></label>
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label"><?php echo $this->lang->line('Tax Number') ?> <span
                                style="color:red">*</span></label>

                        <div class="col-sm-6">
                            <span class="tax_error"></span>
                            <input type="text" placeholder="" class="form-control" name="taxId" id="taxId">
                        </div>
                    </div>
                     <div class="form-group row">
