    ...
    <div class="card card-block">
        ...
        <div class="card-body">
            ...
            <table id="doctable" class="table table-striped table-bordered zero-configuration" cellspacing="0"
                ...
                <tr >
                    <th>#</th>
                    <th><?php echo "Sub Category Name"; //$this->lang->line('Subject') ?></th>
                ...
                <tbody id="sub_category_table_body">
                    <?php if(!empty($sub_categories)) { $c_no=1; foreach($sub_categories as $sub_category){ ?>
                        ...
                        <td><a href="<?php echo base_url('productcategory/edit/?' . http_build_query(array('id' => $sub_category['subcategory_id'])));  ?>" style="display: inline-block; padding:6px; margin-left:1px;" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
