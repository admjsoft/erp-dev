                            ...
                            <ul class="dropdown-menu">
                               ...
                               <?php /* <li data-menu=""><a class="dropdown-item"
                                ...
                                <li data-menu=""><a class="dropdown-item"
                                 ...
                                 <li data-menu=""><a class="dropdown-item"
                                                    href="<?php echo base_url(); ?>employee/attendreport"
                    ...
                    <ul class="dropdown-menu">
                        <?php  if ($this->aauth->premission(21)) {  ?>
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                                <a class="dropdown-item" href="<?php echo base_url(); ?>expenses/add" data-toggle="dropdown"><?= $this->lang->line('Add Expense'); ?></a>
                            </li>
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                        ...
                        <?php  if ($this->aauth->premission(22)) {  ?>
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                                <a class="dropdown-item" href="<?php echo base_url(); ?>expenses/createcat" data-toggle="dropdown"><?= $this->lang->line('Add Category'); ?></a>
                            </li>
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                                <a class="dropdown-item" href="<?php echo base_url(); ?>expenses/categories" data-toggle="dropdown"><?= $this->lang->line('Category List'); ?></a>
                            </li>
                        <?php } ?>
                    </ul>
                </li>
            ...
            <?php if ($this->aauth->premission(19)) {  ?>
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                            <a class="dropdown-item" href="<?php echo base_url(); ?>employee/permissions" data-toggle="dropdown"><?= $this->lang->line('Permissions'); ?></a>
                        </li>
                        <?php } ?>
                    </ul>
                </li>
