            ...
            <div class="navbar-container content">
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    <ul class="nav navbar-nav mr-auto float-left">
                        ...
                        <?php    if ($this->aauth->premission(157)) { ?> <li
                    ...
                    if ($this->aauth->auto_attend()) { ?>
                        <li class="dropdown dropdown-d nav-item">
                            ...
                            <ul
                                ...
                                <br><br>
                                <?php echo '<li class="p-1"><span class="p-1 text-bold-300">' . $this->lang->line('Attendance') . ':</span></li>';
                                if (!$this->aauth->clock()) {
                                    echo '<li class="p-1"><a href="' . base_url() . '/dashboard/clock_in" class="btn btn-outline-success  btn-outline-white btn-md ml-1 mr-1" ><span class="icon-toggle-on" aria-hidden="true"></span> ' . $this->lang->line('ClockIn') . ' <i
                                    class="ficon icon-clock spinner"></i></a></li>';
                                } else {
                                    echo '<li class="p-1"><a href="' . base_url() . '/dashboard/clock_out" class="btn btn-outline-danger  btn-outline-white btn-md ml-1 mr-1" ><span class="icon-toggle-off" aria-hidden="true"></span> ' . $this->lang->line('ClockOut'). ' </a></li>';
                        ...
                        <li class="dropdown dropdown-user nav-item"><a
                            ...
                            <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item"
                                ...
                                <a class="dropdown-item" href="<?php echo base_url('user/logout'); ?>"><i
                                        class="ft-power"></i> <?php echo $this->lang->line('Logout') ?>
                                    [<?php echo $organization->version; ?>]</a>
                                <?php } ?>
                            </div>
                        </li>
                    </ul>
        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                ...
                <ul class="dropdown-menu">
                    ...
                    <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>productcategory"
                            data-toggle="dropdown"><i
                    ...
                    <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>products/stock_transfer"
                            data-toggle="dropdown"><i
                                class="ft-wind"></i><?php echo $this->lang->line('Stock Transfer'); ?></a>
                    </li>
            </li>

            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle"
                    href="#" data-toggle="dropdown"><i class="icon-handbag"></i>
            ...
            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle"
                    href="#" data-toggle="dropdown"><i class="icon-puzzle"></i>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>stockreturn/customer"
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                    data-toggle="dropdown"><i
                        class="icon-diamond"></i><span><?php echo $this->lang->line('Jobsheet') ?></span></a>
                <ul class="dropdown-menu">
                    <?php if($this->aauth->premission(15)){ ?>
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                            class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                class="ft-users"></i><?php echo $this->lang->line('Task Manager') ?></a>
                        <ul class="dropdown-menu">
                            <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>jobsheets/create"
                                    data-toggle="dropdown"><?php echo $this->lang->line('Create Task') ?></a>
                            </li>
                    ...
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                            class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                class="ft-users"></i><?php echo $this->lang->line('My Task') ?></a>
                        <ul class="dropdown-menu">
                            <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>jobsheets/myjobs"
                                    data-toggle="dropdown"><?php echo $this->lang->line('Task List') ?></a>
                            </li>
                        </ul>
                    </li>
                    <?php } ?>
                    <!--  <li data-menu="">
                        ...
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="fa fa-ticket"></i><?php echo $this->lang->line('Jobsheet Tickets') ?></a>
                            <ul class="dropdown-menu">
                                <li data-menu=""><a class="dropdown-item"
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                ...
                <ul class="dropdown-menu">
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                        ...
                        <ul class="dropdown-menu">
                            <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>customers/create"
            ...
            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item dropdown-toggle"
                ...
                <ul class="dropdown-menu">
                    <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>tickets/?filter=unsolved"
                            data-toggle="dropdown"><?php echo $this->lang->line('UnSolved') ?></a>
                    </li>
                    <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>tickets"
                            data-toggle="dropdown"><?= $this->lang->line('Manage Tickets'); ?></a>
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                ...
                <ul class="dropdown-menu">
                    ...
                    <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>transactions/expense"
                            data-toggle="dropdown"><i
                                class="ft-external-link"></i><?= $this->lang->line('Expense'); ?></a>
                    </li>
                </ul>
            </li>
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                ...
                <ul class="dropdown-menu">
                    ...
                    <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>employee/attendances"
                            data-toggle="dropdown"><?= $this->lang->line('Attendance'); ?></a>
                    </li>
                    <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>employee/attendreport"
                            data-toggle="dropdown"><?= $this->lang->line('Attendance Report'); ?></a>
                    </li>
                </ul>
            </li>
            <li data-menu="">
            ...
            </li <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                data-toggle="dropdown"><i
                    class="ft-file-text"></i><span><?php echo $this->lang->line('HRM') ?></span></a>
            <ul class="dropdown-menu">
                <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                ...
                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>employee/attendbreaksetting"
                        data-toggle="dropdown"><?= $this->lang->line('Break Setting'); ?></a>
                </li>
                <li data-menu=""><a class="dropdown-item"
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                    data-toggle="dropdown"><i
                        class="fa fa-money"></i><span><?php echo $this->lang->line('Expenses') ?></span></a>
                <ul class="dropdown-menu">
                    <?php  if ($this->aauth->premission(21)) {  ?>
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                        <a class="dropdown-item" href="<?php echo base_url(); ?>expenses/add"
                            data-toggle="dropdown"><?= $this->lang->line('Add Expense'); ?></a>
                    </li>
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                        <a class="dropdown-item" href="<?php echo base_url(); ?>expenses"
                            data-toggle="dropdown"><?= $this->lang->line('Expenses'); ?></a>
                    </li>
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                        <a class="dropdown-item" href="<?php echo base_url(); ?>expenses/reports"
                            data-toggle="dropdown"><?php echo "Reports"; //$this->lang->line('Expenses'); ?></a>
                    </li>
                    <?php } ?>
                    <?php  if ($this->aauth->premission(22)) {  ?>
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                        <a class="dropdown-item" href="<?php echo base_url(); ?>expenses/createcat"
                            data-toggle="dropdown"><?= $this->lang->line('Add Category'); ?></a>
                    </li>
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                        <a class="dropdown-item" href="<?php echo base_url(); ?>expenses/categories"
                            data-toggle="dropdown"><?= $this->lang->line('Category List'); ?></a>
                    </li>
                    <?php } ?>
                </ul>
            </li>
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu">
                        <a class="dropdown-item" href="<?php echo base_url(); ?>employee/permissions"
                            data-toggle="dropdown"><?= $this->lang->line('Permissions'); ?></a>
                    </li>
                    <?php } ?>
                </ul>
                    ...
                    <ul class="drilldown-menu">
                        <li class="menu-list">
                            <ul class="mega-menu-sub">
                                ...
                                <li><a class="dropdown-item" href="<?php echo base_url(); ?>export/transactions"><i
                    ...
                    <ul class="drilldown-menu">
                        <li class="menu-list">
                            <ul class="mega-menu-sub">
                                ...
                                <li><a class="dropdown-item" href="<?php echo base_url(); ?>export/taxstatement"><i
...
?>
            ...
            <li class="nav-item <?php if (strtolower($c_module) == 'knowledgebase') {echo ' open'; } ?>"><a
                    class="nav-link" href="<?=base_url();?>knowledgebase/"><i
                        class="icon-key"></i><span><?=$this->lang->line('Knowledge Base')?></span></a>

            </li>

            <?php  if(!empty($organization->android_app_link)) { ?>
            <li class="nav-item "><a class="nav-link" target="_blank"
                    href="<?php echo $organization->android_app_link; ?>">
