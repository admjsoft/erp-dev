    ...
    <nav class="header-navbar navbar-expand-md navbar navbar-with-menu fixed-top navbar-semi-dark navbar-shadow">
        <div class="navbar-wrapper">
            ...
            <div class="navbar-container content">
                <div class="collapse navbar-collapse <?php // if($this->aauth->get_employee()){ echo "show"; }?> " id="navbar-mobile">
                    <ul class="nav navbar-nav mr-auto float-left">
                        ...
                        <li class="dropdown  nav-item"><a class="nav-link nav-link-label" href="#"
                                data-toggle="dropdown"><i class="ficon ft-map-pin success"></i></a>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a class="dropdown-item"
                                                                href="<?php echo base_url(); ?>settings/clientTemplate"><i
                                                                    class="ft-chevron-right"></i>
                                                                <?php echo $this->lang->line('Client Template') ?>
                                                            </a></li>
                                                        <li><a class="dropdown-item"
                                                                href="<?php echo base_url(); ?>settings/employeeTemplate"><i
                                                                    class="ft-chevron-right"></i>
                                                                <?php echo $this->lang->line('Employee Template') ?>
                                                            </a></li>
                                                    </ul>
                                                </div>
                                            </div>
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="menu-item"><a href="#"><i
                            ...
                            <ul class="menu-content">
                                ...
                                <li class="menu-item"><a href="<?php echo base_url(); ?>invoices/peppol_invoices">Peppol
                                        Invoices<?php //echo $this->lang->line('Peppol Invoices'); ?></a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-item"><a href="#"><i
    ...
    ?>
                ...
                <li class="nav-item"><a href="#" title="subscripe"><i class="icon-diamond"></i>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" height="1.5em"
                            onclick="subscribemessage('Sales Module');" viewBox="0 0 448 512">
        ...
        echo ' open';
                ...
                <li class="menu-item"><a href="#"><i
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="menu-item"><a
                                href="<?php echo base_url(); ?>products/custom_label"><?php echo $this->lang->line('custom_label'); ?></a>
                        </li>
                        <li class="menu-item"><a
                                href="<?php echo base_url(); ?>products/standard_label"><?php echo $this->lang->line('standard_label'); ?></a>
                        </li>
                    </ul>
                </li>
            </ul>
...
if ($this->aauth->subscribe(15) || $this->aauth->subscribe(16) || $this->aauth->subscribe(17)) {
    ...
    ?>
            <li class="nav-item"><a href="#" title="subscripe"><i class="icon-diamond"></i>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.5em"
                        onclick="subscribemessage('Jobsheet Module');" viewBox="0 0 448 512">
                        <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <style>
                        svg {
                            fill: #dc1853
...
if ($this->aauth->subscribe(3)) {
        ...
        ?>
            ...
            echo ' open';
                ...
                <ul class="menu-content">
                    ...
                    <li class="menu-item"><a href="#"><i class="fa fa-ticket"></i>
                            <?php echo $this->lang->line('Support Tickets') ?></a>
                        <ul class="menu-content">
                            <li class="menu-item"><a
                                    href="<?php echo base_url(); ?>tickets/?filter=unsolved"><?php echo $this->lang->line('UnSolved') ?></a>
                            </li>
    ...
    ?>
            ...
            <li class="nav-item"><a href="#" title="subscripe"><i class="icon-diamond"></i>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.5em"
                        onclick="subscribemessage('Custom Relationship Management Module');" viewBox="0 0 448 512">
                        <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <style>
                        svg {
                            fill: #dc1853
...
if ($this->aauth->subscribe(29)) {
    ...
    ?>
            <li class="nav-item"><a href="#" title="subscripe"><i class="fa fa-folder-o"></i
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.5em"
                        onclick="subscribemessage('File Manager Module');" viewBox="0 0 448 512">
                        <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <style>
                        svg {
                            fill: #dc1853
        ...
        ?>
            ...
            echo ' open';
                ...
                <ul class="menu-content">
                    ...
                    <li class="menu-item">
                        <a href="<?php echo base_url(); ?>tools/todo"><i class="icon-list"></i>
                            <?php echo $this->lang->line('To Do List'); ?></a>
                    </li>
    ...
    ?>
        ...
        echo ' open';
                ...
                <ul class="menu-content">
                    ...
                    <li class="menu-item">
                        <a href="<?php echo base_url(); ?>manager/todo"><i class="icon-list"></i>
                            <?php echo $this->lang->line('To Do List'); ?></a>
                    </li>
...
if ($this->aauth->subscribe(5)) {
        ...
        ?>
            ...
            echo ' open';
                ...
                <ul class="menu-content">
                    ...
                    <li class="menu-item"><a href="#"><i class="icon-wallet"></i>
                            <?php echo $this->lang->line('Transactions') ?></a>
                        <ul class="menu-content">
                            <li class="menu-item"><a
            ...
            echo ' open';
                ...
                <ul class="menu-content">
                    <li class="menu-item"><a href="#"><i class="icon-trophy"></i>
                            <?php echo $this->lang->line('Coupons') ?></a>
                        <ul class="menu-content">
                            <li class="menu-item"><a
    ...
    ?>
            <li class="nav-item"><a href="#" title="subscripe"><i class="icon-calculator"></i
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.5em"
                        onclick="subscribemessage('Accounts Module');" viewBox="0 0 448 512">
                        <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <style>
                        svg {
                            fill: #dc1853
    ...
    if ($this->aauth->premission(158)) {
        ?>
            ...
            echo ' open';
                ...
                <ul class="menu-content">
                    <li class="menu-item">
                        <a href="<?php echo base_url(); ?>register"><i class="icon-eyeglasses"></i>
                            <?php echo $this->lang->line('Business Registers'); ?>
                        </a>
                    </li>

                    <li class="menu-item"><a href="#"><i class="icon-doc"></i>
                            <?php echo $this->lang->line('Statements') ?></a>
                        <ul class="menu-content">
                    ...
                    <li class="menu-item"><a href="#"><i class="icon-bar-chart"></i>
                            <?php echo $this->lang->line('Graphical Reports') ?>
                        </a>
                        <ul class="menu-content">
                    ...
                    <li class="menu-item"><a href="#"><i class="icon-bulb"></i>
    ...
    if ($this->aauth->premission(6)) {
        ?>
                ...
                <ul class="menu-content">
                    <li class="menu-item">
                        <a href="<?php echo base_url(); ?>tools/notes"><i class="icon-note"></i>
                            <?php echo $this->lang->line('Notes'); ?></a>
                    </li>
                    <li class="menu-item">
                        <a href="<?php echo base_url(); ?>events"><i class="icon-calendar"></i>
                            <?php echo $this->lang->line('Calendar'); ?></a>
                    </li>
                    <li class="menu-item">
                        <a href="<?php echo base_url(); ?>tools/documents"><i class="icon-doc"></i>
            ...
            <li class="nav-item"><a href="#" title="subscribe"><i class="icon-note"></i
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" onclick="subscribemessage('Miscellaneous Module');"
                        height="1.5em" viewBox="0 0 448 512">
                        <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <style>
                        svg {
...
if ($this->aauth->subscribe(30)) {
    ...
    ?>
            <li class="nav-item"><a href="#" title="subscripe"><i class="icon-basket"></i
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.5em"
                        onclick="subscribemessage('Invoices Module');" viewBox="0 0 448 512">
                        <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <style>
                        svg {
                            fill: #dc1853
...
if ($this->aauth->subscribe(37)) {
            ...
            echo ' open';
                ...
                <ul class="menu-content">
                    ...
                    <li class="menu-item"><a href="<?php echo base_url(); ?>ecommerce/online_platforms">
                            <?php echo $this->lang->line('Online Platforms'); ?></a>
                    </li>
                    <li class="menu-item"><a href="<?php echo base_url(); ?>ecommerce/categories">
                            <?php echo $this->lang->line('Categories'); ?></a>
                    </li>
                    <li class="menu-item"><a href="<?php echo base_url(); ?>ecommerce/sub_categories">
                            <?php echo $this->lang->line('Sub Categories'); ?></a>
                    </li>


                    <li class="menu-item"><a href="<?php echo base_url(); ?>ecommerce/publishing">
                            <?php echo $this->lang->line('Publishing'); ?></a>
                    </li>
                    <li class="menu-item"><a href="<?php echo base_url(); ?>ecommerce/analytics">
    ...
    ?>
            <li class="nav-item"><a href="#" title="subscripe"><i class="icon-diamond"></i>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.5em"
                        onclick="subscribemessage('E-Commerce Module');" viewBox="0 0 448 512">
                        <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <style>
                        svg {
                            fill: #dc1853
...
if ($this->aauth->subscribe(9)) {
    ...
    if ($this->aauth->premission(9)) {
        ...
        href="<?php echo base_url(); ?>employee/permissions"><?= $this->lang->line('Permissions'); ?></a>
            ...
            <li class="menu-item">
                <a href="<?php echo base_url(); ?>employee/departments"><i class="icon-folder"></i>
                    <?php echo $this->lang->line('Departments'); ?></a>
            </li>
            <li class="menu-item">
                <a href="<?php echo base_url(); ?>employee/roles"><i class="icon-folder"></i>
                    <?php echo $this->lang->line('Roles'); ?></a>
            </li>
        ...
        if ($this->aauth->get_user()->roleid == 2) {
            ...
            <li class="menu-item  has-sub <?php if ($this->li_a == "fwms") {
                ...
                <ul class="menu-content">
                    ...
                    <li class="menu-item">
                        <a href="<?php echo base_url(); ?>fwms/fwmsemployees"><i class=""></i>
                            <?php echo $this->lang->line('Employees'); ?></a>
                    </li>
            ...
            <li class="menu-item  has-sub <?php if ($this->li_a == "fwms") {
                ...
                <ul class="menu-content">
                    ...
                    <li class="menu-item">
                        <a href="<?php echo base_url(); ?>fwms/fwmsreport"><i class=""></i>
                            <?php echo $this->lang->line('Report'); ?></a>
                    </li>
...
if ($this->aauth->subscribe(33)) {
        ...
        ?>
            ...
            echo ' open';
                ...
                <ul class="menu-content">
                    ...
                    <li class="menu-item"><a href="<?php echo base_url(); ?>scheduler/scheduleList"><i class=""></i>
                            <?php echo $this->lang->line('Schedule List') ?></a>
                    </li>
    ...
    ?>
            <li class="nav-item"><a href="#" title="subscripe"><i class="ft-file-text"></i
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.5em"
                        onclick="subscribemessage('Scheduler Module');" viewBox="0 0 448 512">
                        <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <style>
                        svg {
                            fill: #dc1853
...
if ($this->aauth->subscribe(34)) {
            ...
            echo ' open';
                ...
                <ul class="menu-content">
                    <li class="menu-item"><a href="<?php echo base_url(); ?>asset/assetlist"><i class=""></i>
                            <?php echo $this->lang->line('View Assets') ?></a>
                    </li>
                    <li class="menu-item">
                        <a href="<?php echo base_url(); ?>asset/asset_history"><i class=""></i>
                            <?php echo $this->lang->line('Asset History'); ?></a>
                    </li>
                    <li class="menu-item">
                        <a href="<?php echo base_url(); ?>asset/assetcategory"><i class=""></i>
                            <?php echo $this->lang->line('Asset Category'); ?></a>
                    </li>
                    <li class="menu-item">
                        <a href="<?php echo base_url(); ?>asset/assetsubcategory"><i class=""></i>
                            <?php echo $this->lang->line('Asset Sub Category'); ?></a>
                    </li>
                    <li class="menu-item">
                        <a href="<?php echo base_url(); ?>asset/assetStatus"><i class=""></i>
                            <?php echo $this->lang->line('Asset Status'); ?></a>
                    </li>
                    <li class="menu-item">
                        <a href="<?php echo base_url(); ?>asset/comments"><i class=""></i>
                            <?php echo $this->lang->line('Comments'); ?></a>
                    </li>

            </li>
            <li class="menu-item">
                <a href="<?php echo base_url(); ?>asset/printBarcode"><i class=""></i>
                    <?php echo $this->lang->line('Print Barcode'); ?></a>
            </li>
            </ul>
            </li><?php }
} else {
    ?>
            <li class="nav-item"><a href="#" title="subscripe"><i class="ft-file-text"></i
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.5em"
                        onclick="subscribemessage('Asset Management Module');" viewBox="0 0 448 512">
                        <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <style>
                        svg {
                            fill: #dc1853
        ...
        ?>
            ...
            echo ' open';
                ...
                <ul class="menu-content">
                    ...
                    <li class="menu-item">
                        <a href="<?php echo base_url(); ?>payroll/payroll"><i class=""></i>
                            <?php echo $this->lang->line('Payroll'); ?></a>
                    </li>
                    <li class="menu-item">
                        <a href="<?php echo base_url(); ?>payroll/viewpaySlip"><i class=""></i>
                            <?php echo $this->lang->line('View Payslips'); ?></a>
                    </li>
                    <li class="menu-item">
                        <a href="<?php echo base_url(); ?>payroll/payrollReport"><i class=""></i>
                            <?php echo $this->lang->line('Payroll Report'); ?></a>
                    </li>
    ...
    ?>
            <li class="nav-item"><a href="#" title="subscripe"><i class="ft-file-text"></i
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 448 512"
                        onclick="subscribemessage('Expense Module');">
                        <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <style>
                        svg {
                            fill: #dc1853
    ...
    echo ' open';
            ...
            <ul class="menu-content">
                <li class="menu-item"><a href="<?php echo base_url(); ?>export/crm"><i class="fa fa-caret-right"></i>
                        <?php echo $this->lang->line('Export People Data'); ?>
                    </a>
                </li>
                ...
                <li><a href="<?php echo base_url(); ?>export/account"><i class="fa fa-caret-right"></i>
                        <?php echo $this->lang->line('Account Statements'); ?>
                    </a></li>
                <li><a href="<?php echo base_url(); ?>export/people_products"><i class="fa fa-caret-right"></i>
                        <?php echo $this->lang->line('ProductsAccount Statements'); ?>
                    </a></li>
                <li><a href="<?php echo base_url(); ?>export/taxstatement"><i class="fa fa-caret-right"></i>
                        <?php echo $this->lang->line('Tax_Export'); ?>
                    </a></li>
                <li><a href="<?php echo base_url(); ?>export/dbexport"><i class="fa fa-caret-right"></i>
                        <?php echo $this->lang->line('Database Backup'); ?>
                    </a></li>
                <li><a href="<?php echo base_url(); ?>import/products"><i class="fa fa-caret-right"></i></i>
                        <?php echo $this->lang->line('Import Products'); ?>
                    </a></li>
                <li><a href="<?php echo base_url(); ?>import/customers"><i class="fa fa-caret-right"></i>
...
if ($this->aauth->subscribe(38)) {
        ...
        ?>
            ...
            echo ' open';
                ...
                <ul class="menu-content">
                    ...
                    <li class="menu-item"><a href="<?php echo base_url(); ?>digitalmarketing/customers_list">
                            <?php echo $this->lang->line('Customers List'); ?></a>
                    </li>
                    <li class="menu-item"><a href="<?php echo base_url(); ?>digitalmarketing/contacts">
                            <?php echo $this->lang->line('Contact management'); ?></a>
                    </li>
                    <li class="menu-item"><a href="<?php echo base_url(); ?>digitalmarketing/folders">
                            <?php echo $this->lang->line('Folder Management'); ?></a>
                    </li>
                    <li class="menu-item"><a href="<?php echo base_url(); ?>digitalmarketing/lists">
                            <?php echo $this->lang->line('List management'); ?></a>
                    </li>

                    <li class="menu-item"><a href="<?php echo base_url(); ?>digitalmarketing/transactional">
                            <?php echo $this->lang->line('Transactional'); ?></a>

                        <ul class="menu-content">
                            <li class="menu-item"><a
                                    href="<?php echo base_url(); ?>digitalmarketing/transactions/email">
                                    <?php echo $this->lang->line('Email'); ?></a>
                            </li>
                            <li class="menu-item"><a href="<?php echo base_url(); ?>digitalmarketing/transactions/sms">
                                    <?php echo $this->lang->line('Sms'); ?></a>
                            </li>
                            <li class="menu-item"><a
                    ...
                    <li class="menu-item"><a href="<?php echo base_url(); ?>digitalmarketing/EmailMarketing">
                            <?php echo $this->lang->line('Email Marketing'); ?></a>
                        <ul class="menu-content">
                            <li class="menu-item"><a
                    ...
                    <li class="menu-item"><a href="<?php echo base_url(); ?>digitalmarketing/whatsappMarketing">
                            <?php echo $this->lang->line('Whatsapp Marketing'); ?></a>
                        <ul class="menu-content">
                            <li class="menu-item"><a
    ...
    ?>
            ...
            <li class="nav-item"><a href="#" title="subscripe"><i class="ft-file-text"></i
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 448 512"
                        onclick="subscribemessage('Digital Marketing Module');">
                        <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <style>
                        svg {
                            fill: #dc1853
    ...
    <div class="modal fade" id="addReferral" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content ">
                <form method="post" id="" class="form-horizontal" action="<?php echo base_url("customers/referral") ?>">
                    <!-- Modal Header -->
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="name">Referral Name <span
                                            style="color:red">*</span></label>

                                    <div class="col-sm-4">
                                        <span class="name_error"></span>

                                        <input type="text" placeholder="Referer Name" class="form-control margin-bottom"
                                            id="rname" name="rname">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-sm-3 col-form-label" for="phone">Company Name<span
                                            style="color:red">*</span></label>

                                    <div class="col-sm-4">
                                        <span class="desc_error"></span>

                                        <input type="text" placeholder="Company Name" class="form-control margin-bottom"
                                            name="company" id="company">
                                    </div>
                                </div>
                                <div class="form-group row">

                                    <label class="col-sm-3 col-form-label" for="phone">Contact Number<span
                                            style="color:red">*</span></label>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="phone">Email Id<span
                                            style="color:red">*</span></label>

                                    <div class="col-sm-4">
                                        <span class="desc_error"></span>

                                        <input type="email" placeholder="Email Id" class="form-control margin-bottom"
                                            name="email" id="email">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="phone">Remarks<span
                                            style="color:red">*</span></label>
