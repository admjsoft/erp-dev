                        ...
                        <div class="">
                            ...
                            <div class="title-action">
                                ...
                                <a href="#part_payment" data-toggle="modal" data-remote="false" data-type="reminder"
                                    class="btn btn-large btn-success mb-1" title="Partial Payment"><span
                                ...
                                <a href="<?php echo $link; ?>" class="btn btn-purple mb-1"><i class="fa fa-globe"></i>
                                ...
                                <a href="#pop_model" data-toggle="modal" data-remote="false"
                                    class="btn btn-large btn-cyan mb-1" title="Change Status"><span
                                        class="fa fa-retweet"></span> <?php echo $this->lang->line('Change Status') ?>
                                </a>
                                ...
                                <a href="#pop_model2" data-toggle="modal" data-remote="false"
                                    class="btn btn-large btn-vimeo  mb-1" title="Change Status"><span
                        ...
                        <div id="invoice-company-details" class="row mt-2">
                            ...
                            <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
                                <h3><?php echo $this->lang->line('Subscription');
                                    echo '</h2><h4><span class="st-sub' . $invoice['i_class'] . '">' . $this->lang->line('Sub_' . $invoice['i_class']) . '</span>'; ?>
                                </h3>
                            ...
                            <p class="pb-1">' . $this->lang->line('Reference') . ':' . $invoice['refer'] . '</p>'; ?>
                                <ul class="px-0 list-unstyled">
                                    ...
                                    <li class="lead text-bold-800">
                                        <?= amountExchange($invoice['total'], 0, $this->aauth->get_user()->loc) ?></li>
                                </ul>
                            </div>
                        </div>
                        <!--/ Invoice Company Details -->
                                    ...
                                    <table class="table table-striped">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-xs-left"><?php echo $this->lang->line('Discount') ?>
                                                </th>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-bold-800"><?php echo $this->lang->line('Total') ?>
                                                    </td>
                                                ...
                                                <tr class="bg-grey bg-lighten-4">
                                                    <td class="text-bold-800">
                                                        <?php echo $this->lang->line('Balance Due') ?></td>
                                                    <td class="text-bold-800 text-xs-right">
                                                        <?php $myp = '';
        ...
        $('#fileupload').fileupload({
                ...
                formData: {
                    ...
                    $.each(data.result.files, function(index, file) {
                        $('#files').append(
                            '<tr><td><a data-url="<?php echo base_url() ?>subscriptions/file_handling?op=delete&name=' +
                            file.name +
                            '&invoice=<?php echo $invoice['iid'] ?>" class="aj_delete"><i class="btn-danger btn-sm fa fa-trash"></i> </a>' +
                            file.name + ' </td></tr>');
