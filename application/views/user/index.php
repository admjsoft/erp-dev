...
<div class="container my-5" style="box-shadow: 1px 4px 20px -5px #545454ed;border-radius: 10px;">
    <div class="row" style="background-color:#E2F6EF;padding:15px;border-radius: 10px 10px 0px 0px;">
        <div class="col-5 text-left">
           <?php /* <img src="<?php echo base_url()?>userfiles/theme/logo-header.png"
            alt="logo" style="max-height: 10rem;  max-width: 10rem;"> */ ?>
        </div>
        <div class="col-7 text-right">
            <h5 class="logtxt" style="color:#24436D;
    margin: 0px;"><strong><?php //echo $this->lang->line('employee_login') ?>Management Login</strong></h5>
    </div>
    </div>

    <div class="row">
        <div class="col-md-6 " style=" background: url(<?php echo base_url(); ?>/app-assets/images/backgrounds/login-side.jpg) no-repeat;background-size: cover;background-position: center; ">
<div style="display: flex; align-items: center; justify-content: center;margin-top: 57px" class="row">
    <div class="col-6"><img src="<?php echo base_url()?>userfiles/theme/logo-header.png" width="100%"/></div>
    <div class="col-6"> <img src="<?php echo base_url(); ?>/app-assets/images/elements/ai.png" width="100%" /></div>
</div>
