                ...
                <form method="post" id="data_form" class="form-horizontal">
                    ...
                    <div class="form-group row bg-purple bg-lighten-4 ">
                        ...
                        <div class="col-md-10"><label class="col col-form-label"
                            ...
                            <input type="text" placeholder="Project Title" class="form-control mb-1 required"
                                name="name">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4  rounded bg-blue bg-lighten-4"><label class="col col-form-label"
                            ...
                            <select name="customerview" class="form-control mb-1">
                                <option value='true'><?php echo $this->lang->line('True'); ?></option>
                                <option value='false'><?php echo $this->lang->line('False'); ?></option>
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4 border-blue rounded"><label class="control-label"
                            ...
                            <input type="text" class="form-control  required" placeholder="Start Date" name="sdate"
                        ...
                        <div class="col-md-4 rounded bg-blue bg-lighten-4"><label class="control-label"
                            ...
                            <input type="text" id="pdate_2" class="form-control  required edate" placeholder="End Date"
                                name="edate" autocomplete="false"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4   border-blue rounded "><label class="col-form-label"
                            ...
                            <input type="text" placeholder="Phase A,B,C" class="form-control mb-1  required"
                                name="phase">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4 border-blue rounded"><label class="col col-form-label" for="name">Link to
                                calendar</label>
                        ...
                        <div class="col-md-8 rounded bg-blue bg-lighten-4"><label class="col col-form-label"
                            ...
                            <input type="text" placeholder="Tags" class="form-control margin-bottom  required"
                                name="tags">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-sm-2 col-form-label" for="name"><?php echo $this->lang->line('Task Communication'); ?></label>

                        <div class="col-sm-4">
                            <select name="ptype" class="form-control">
                                <option value='0'><?php echo $this->lang->line('No'); ?></option>
                                <option value='1'><?php echo $this->lang->line('Emails to team'); ?></option>
                                <option value='2'><?php echo $this->lang->line('Emails to team, customer'); ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
