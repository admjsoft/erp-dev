                                ...
                                <li data-block="sec" class="<?php if (!$flag) {
                                    ...
                                    <div class="timeline-panel">
                                        <div class="timeline-heading">
                                            ...
                                            <p>
                                                <small class="text-muted"><i
                                                            class="fa fa-clock-o"></i> <?php echo $row['sdate'] . ' ~ ' . $row['edate'] . '</small><a href="#" class=" float-xs-right delete-custom" data-did="2" data-object-id="' . $row['id'] . '"><i class="danger fa fa-trash"></i></a>'; ?>
                                            </p>
                                        </div>
                                        <div class="timeline-body">
                                            <p><?php echo $row['exp'];
