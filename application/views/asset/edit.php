                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active show" id="base-tab1" data-toggle="tab"
                                       ...
                                       aria-selected="true"><?php echo $this->lang->line(
                                           "Basic Info"
                                       ); ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="base-tab2" data-toggle="tab" aria-controls="tab2"
                                       href="#tab2" role="tab"
                                       aria-selected="false"><?php echo $this->lang->line(
                                           "Other Info"
                                       ); ?></a>
                                </li>
                                  <li class="nav-item">
                                ...
                                <div class="tab-pane active show" id="tab1" role="tabpanel" aria-labelledby="base-tab1">
                                    <div class="form-group row mt-1">
                                        ...
                                        <label class="col-sm-2 col-form-label"
                                               for="name"><?php echo $this->lang->line(
                                                   "Asset Id"
                                               ); ?></label>

                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Asset Id"
                                                   class="form-control margin-bottom b_input required" name="AssetId" value="<?php echo $aasetvalue[
                                                       "asset_id"
                                                   ]; ?>"
                                                   id="AssetId">
                     ...
                     <label class="col-sm-2 col-form-label"
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Asset Model No"
                                                   class="form-control margin-bottom b_input" name="AssetModelNo" id="AssetModelNo" value="<?php echo $aasetvalue[
                                                       "asset_modelno"
                                                   ]; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                         ...
                                         <label class="col-sm-2 col-form-label"
                                               for="phone"><?php echo $this->lang->line(
                                                   "Name"
                                               ); ?></label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Description"
                                                   class="form-control margin-bottom required b_input" name="Description" value="<?php echo $aasetvalue[
                                                       "asset_modelno"
                                                   ]; ?>"
                                                   id="Description">
                                        </div>
                                    ...
                                    <div class="form-group row">
<label class="col-sm-2 col-form-label"
                                               for="address"><?php echo $this->lang->line(
                                                   "Unit Price"
                                               ); ?></label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-2 col-form-label"
                                               for="city"><?php echo $this->lang->line(
                                                   "Asset Status"
                                               ); ?></label>
                                        <div class="col-sm-8">
                                           <select id="AssetStatus" class="form-control" style="width:100%;" 
										   data-val="true" data-val-required="The Category field is required." name="AssetStatus">
											  ...
											  <?php if ($aasetvalue["asset_status"] == $statusval["id"]) {
                 echo "selected";
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-2 col-form-label"
                                               for="region"><?php echo $this->lang->line(
                                                   "Date Of Purchase"
                                               ); ?></label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-2 col-form-label"
                                               for="country"><?php echo $this->lang->line(
                                                   "Category"
                                               ); ?></label>
    ...
    echo "selected";
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-2 col-form-label"
                                               for="postbox"><?php echo $this->lang->line(
                                                   "Sub Category"
                                               ); ?></label>
    ...
    echo "selected";
                                        ...
                                        <div class="col-sm-8">
                                          <select id="Department" class="form-control" style="width:100%;" 
										   data-val="true" data-val-required="The Category field is required." name="Department">
                                                    <option disabled="" selected="">--- SELECT ---</option>
                                              <?php foreach (
                                                  $department
                                                  as $departmentval
...
<option value="5" <?php if ($aasetvalue["supplier"] == 5) {
    echo "selected";
                              ...
                              <div class="form-group row">
                                        ...
                                        <label class="col-sm-2 col-form-label"
                                               for="name_s"><?php echo $this->lang->line(
                                                   "Date Of Manufacture"
                                               ); ?></label>

                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Date Of Manufacture"
                                                   class="form-control margin-bottom b_input" name="DateOfManufacture" data-toggle="datepicker"
                                                   id="DateOfManufacture" value="<?php echo $aasetvalue[
                                                       "date_of_manufacture"
                                                   ]; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-2 col-form-label"
                                               for="phone_s"><?php echo $this->lang->line(
                                                   "Year Of Valuation"
                                               ); ?></label>

                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Year Of Valuation"
                                                   class="form-control margin-bottom b_input" name="YearOfValuation" data-toggle="datepicker"
                                                   id="YearOfValuation" value="<?php echo $aasetvalue[
                                                       "year_of_valuation"
                                                   ]; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Location"
                                                   ...
                                                   id="Location" value="<?php echo $aasetvalue[
                                                       "location"
                                                   ]; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-2 col-form-label"
                                               for="city_s"><?php echo $this->lang->line(
                                                   "Image URL"
                                               ); ?></label>

                                        <div class="col-sm-8">
<input type="file" data-val="true" data-val-required="The ImageURLDetails field is required." id="image" name="image">
                                        </div>
                                    </div>
                                    <div class="form-group row">

                                        <label class="col-sm-2 col-form-label"
                                               for="region_s"><?php echo $this->lang->line(
                                                   "Note"
                                               ); ?></label>
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Note"
                                                   ...
                                                   id="note" value="<?php echo $aasetvalue[
                                                       "note"
                                                   ]; ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane show" id="tab3" role="tabpanel" aria-labelledby="base-tab3">
                                                 ...
                                                 <div class="form-group row"><label class="col-sm-2 col-form-label"
                                                                       for="Discount"><?php echo $this->lang->line(
                                                                           "Assign Employee"
                                                                       ); ?> </label>
                                        <div class="col-sm-6">
                                               <select id="employee" class="form-control" style="width:100%;" 
										   data-val="true" data-val-required="Employee field is required." name="employee">
                                                    <option disabled="" selected="">--- SELECT ---</option>
