        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><?php echo $this->lang->line('delete this asset') ?>no Are you sure you want to delete this
                        asset?</p>
                </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content ">
            <form method="post" id="product_action" class="form-horizontal"
                action="<?php echo base_url("asset/save_asset_category") ?>" onSubmit="return validateForm(event);">
                <!-- Modal Header -->
                <div class="modal-header">
