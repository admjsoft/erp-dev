                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Asset Id"
                                                   class="form-control margin-bottom b_input required" name="AssetId" value="<?php echo $assetId;?>"
                                                   id="AssetId">
                                        </div>
                                    </div>
                     ...
                     <label class="col-sm-2 col-form-label"
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Asset Model No"
                                                   class="form-control margin-bottom b_input" name="AssetModelNo" id="AssetModelNo">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                          ...
                                          <label class="col-sm-2 col-form-label" for="email"><?php echo $this->lang->line('Description') ?></label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
										   ...
										   data-val="true" data-val-required="The Category field is required." name="AssetStatus">
											  ...
											  {
												  ?>
											  <option value="<?php echo $statusval['id'];?>"><?php echo $statusval['name'];?></option>
                                           <?php
										   }
										   ?>
										   </select>
                                        ...
                                        <div class="col-sm-8">
                                          <select id="Department" class="form-control" style="width:100%;" 
										   data-val="true" data-val-required="The Category field is required." name="Department">
											  ...
											  {
												  ?>
											  <option value="<?php echo $departmentval['id'];?>"><?php echo $departmentval['val1'];?></option>
                                           <?php
										   }
										   ?>
											  </select>
...
<option value="5">Recruitment</option>
                              ...
                              <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-2 col-form-label" for="WarranetyInMonth"><?php echo $this->lang->line('Warranety In Month') ?></label>
...
<div class="modal fade show" id="ExtraBigModal" role="dialog" style="display: block; padding-right: 17px;" aria-modal="true">
