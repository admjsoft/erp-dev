            ...
            <table id="trans_table" class="table table-striped table-bordered zero-configuration" cellspacing="0"
                ...
                <thead>
                    <tr>
                        ...
                        <th><?php echo $this->lang->line('Date of referral') ?></th>
						   <th><?php echo $this->lang->line('Referral Name') ?></th>
					    <th><?php echo $this->lang->line('Company name') ?></th>
						 <th><?php echo $this->lang->line('Earning Percentage') ?></th>
...
<script type="text/javascript">
 ...
 {
	$.ajax({
                "url": "<?php echo site_url('dashboard/getApprovedreferences') ?>",
                "type": "POST",
                'data': {
...
//$(".modal-body").html(msg);
    ...
    $(document).ready(function () {
        ...
        $('#trans_table').removeAttr('width').DataTable( {
            ...
            <?php datatable_lang();?>
            "ajax": {
                "url": "<?php echo site_url('dashboard/getAprrovedReferrerList')?>",
                "type": "POST",
                'data': {'approved':approved,'<?=$this->security->get_csrf_token_name()?>': crsf_hash}
            },
            "columnDefs": [
                {
                    "targets": [0],
