           ...
           <script src="https://cdn.jsdelivr.net/npm/@tinymce/tinymce-jquery@1/dist/tinymce-jquery.min.js"></script>
            ...
            <div class="form-group row">
                    ...
                    <div class="col-sm-6 offset-sm-6 text-right"  id="cr_invoice_search_block">
                        <label class="float-left" for="autocomplete">Search Invoices (Paid):</label>
                ...
                <form method="post" id="data_form">
                    ...
                    <div id="invoice_products_details_block">
                    <div id="saman-row">
                        <table class="table-responsive tfr my_stripe">
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control req amnt" name="product_qty[]" id="<?php echo "amount-".$pc; ?>"
                                           onkeypress="return isNumber(event)" onkeyup="rowTotal('0'), billUpyog()"
                                           autocomplete="off" value="1"></td>
                                <td><input type="text" class="form-control req prc" name="product_price[]" id="<?php echo "price-".$pc; ?>"
                                           onkeypress="return isNumber(event)" onkeyup="rowTotal('0'), billUpyog()"
                                           autocomplete="off" value="<?php echo $prod['fproduct_price']; ?>"></td>
                                <td><input type="text" class="form-control vat " name="product_tax[]" id="<?php echo "vat-".$pc; ?>"
                                           onkeypress="return isNumber(event)" onkeyup="rowTotal('0'), billUpyog()"
                                           autocomplete="off" value="<?php echo $prod['taxrate']; ?>"></td>
                                ...
                                <td><input type="text" class="form-control discount" name="product_discount[]"
                                           ...
                                           onkeyup="rowTotal('0'), billUpyog()" autocomplete="off" value="<?php echo $prod['disrate']; ?>"></td>
                                <td><span class="currenty"><?php echo $this->config->item('currency'); ?></span>
                                    <strong><span class='ttlText' id="<?php echo "result-".$pc; ?>"><?php echo $prod['fproduct_price']; ?></span></strong></td>
                                    <td class="text-center"><button type="button" data-rowid="<?php echo $pc; ?>" class="btn btn-danger removeProd" title="Remove"> <i class="fa fa-minus-square"></i> </button> </td>
                                <input type="hidden" name="taxa[]" id="<?php echo "taxa-".$pc; ?>" value="0">
                                <input type="hidden" name="disca[]" id="<?php echo "disca-".$pc; ?>" value="0">
                                <input type="hidden" class="ttInput" name="product_subtotal[]" id="<?php echo "total-".$pc; ?>" value="0">
                                <input type="hidden" class="pdIn" name="pid[]" id="<?php echo "pid-".$pc; ?>" value="<?php echo $prod['pid']; ?>">
                            ...
                            <tr>
                                <td colspan="8"><textarea id="<?php echo "dpid-".$pc; ?>" class="form-control" name="product_description[]"
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                ...
                                <td align="left" colspan="2"><span
                                    ...
                                    <span id="taxr" class="lightMode"><?php echo $tax; ?></span></td>
                            </tr>
                            <tr class="sub_c" style="display: table-row;">
                                ...
                                <td align="left" colspan="2"><span
                                            class="currenty lightMode"><?php echo $this->config->item('currency'); ?></span>
                                    <span id="discs" class="lightMode"><?php echo $discount; ?></span></td>
                            </tr>
                            ...
                            <tr class="sub_c" style="display: table-row;">
                                <td colspan="2"><?php if ($exchange['active'] == 1){
                                    ...
                                    <select name="mcurrency"
                                            class="selectpicker form-contol">
                                ...
                                <td align="left" colspan="2"><input type="text" name="total" class="form-control"
                                                                    id="invoiceyoghtml" value="<?php echo $total; ?>"readonly="">
                    ...
                    <div class="float-right mb-5"><input type="submit" class="btn btn-success sub-btn"
...
if (invoice_id) {       
    ...
    type: 'POST',        
    dataType: 'json',
    url: '<?php echo base_url('deliveryorder/get_invoice_product_details') ?>',
    ...
    success: function (response) {
        ...
        if(response.status == '200')
        {
            ...
            $('#invoice_products_details_block').html('');
            $('#invoice_products_details_block').html(response.html);
...
// $(document).on('click', '#generate_po_btn', function() {
