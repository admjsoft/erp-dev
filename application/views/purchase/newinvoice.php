            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-4 text-right">
                        <!-- Small Button -->
                        <a href="<?php echo base_url('purchase'); ?>"> <button type="button" class="btn btn-sm btn-primary"><?php echo $this->lang->line('List'); ?> </button></a>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 offset-sm-6 text-right" id="cr_invoice_search_block">
                        <label class="float-left" for="autocomplete"><?php echo $this->lang->line('Search Invoices ( Buy Products Based On Customer Paid Invoice )'); ?></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 cmp-pnl">
                            <div class="inner-cmp-pnl">
                                    ...
                                    <div class="col-sm-6"><label for="invociedate"
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"><span class="icon-calendar4"
                                                    aria-hidden="true"></span></div>
                                            <input type="text" class="form-control required" placeholder="Billing Date"
                                                name="invoicedate" data-toggle="datepicker" autocomplete="false">
                                        </div>
                                    </div>
                                    <div class="col-sm-6"><label for="invocieduedate"
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control required" id="tsn_due"
                                                name="invocieduedate" placeholder="Due Date" data-toggle="datepicker"
                                                autocomplete="false">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <label for="taxformat" class="caption"><?php echo $this->lang->line('Tax') ?>
                                        </label>
                            ...
                            <table class="table-responsive tfr my_stripe">
                                <thead>
                                    ...
                                    <tr class="item_header bg-gradient-directional-amber">
                                        ...
                                        <th width="8%" class="text-center"><?php echo $this->lang->line('Quantity') ?>
                                        </th>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        <td><input type="text" class="form-control text-center" name="product_name[]"
                                                ...
                                                id="<?php echo 'productname-'.$pc; ?>"
                                                value="<?php echo $prod['product_name']; ?>">
                                        </td>
                                        ...
                                        <td><input type="text" class="form-control vat " name="product_tax[]"
                                                id="<?php echo "vat-".$pc; ?>" onkeypress="return isNumber(event)"
                                                onkeyup="rowTotal('0'), billUpyog()" autocomplete="off"
                                        ...
                                        <td><input type="text" class="form-control discount" name="product_discount[]"
                                                ...
                                                onkeyup="rowTotal('0'), billUpyog()" autocomplete="off"
                                                value="<?php echo $prod['disrate']; ?>"></td>
                                        ...
                                        <td class="text-center"><button type="button" data-rowid="<?php echo $pc; ?>"
                                                class="btn btn-danger removeProd" title="Remove"> <i
                                                    class="fa fa-minus-square"></i> </button> </td>
                                    ...
                                    echo $this->lang->line('Payment Currency client') . ' <small>' . $this->lang->line('based on live market') ?></small>
                                        ...
                                        <td align="left" colspan="2"><input type="text" name="total"
                                                class="form-control" id="invoiceyoghtml" value="<?php echo $total; ?>"
                                                readonly="">
                                        ...
                                        <td colspan="2">
                                            <div>
                                                ...
                                                <fieldset class="right-radio">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" class="custom-control-input"
                                                            name="update_stock" id="customRadioRight2" value="no" checked="">
                                                        <label class="custom-control-label"
