                ...
                <table id="th_vendors" class="table table-striped table-bordered zero-configuration ">
                    ...
                    <tbody>
                        ...
                        <?php if(!empty($contacts)){ $c=1; foreach($contacts as $contact){ ?>
                            ...
                            <a href="<?php echo base_url('digitalmarketing/contact_edit/?' . http_build_query(array('id' => $contact['id']))); ?>" style="display: inline-block; padding:6px; margin-left:1px;" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
                            <a href="<?php echo base_url('digitalmarketing/contact_view/?' . http_build_query(array('id' => $contact['id']))); ?>" style="display: inline-block; padding:6px; margin-left:1px;" class="btn btn-success btn-xs"><i class="fa fa-eye"></i></a>
                            <?php // } ?>
                            <a contact_id="<?php echo $contact['id']; ?>" style="display: inline-block; padding:6px; margin-left:1px;" class="btn btn-danger btn-xs vendor_delete"><i class="fa fa-trash"></i></a></td>
                            </tr> 
                        <?php $c++; }} ?>   
