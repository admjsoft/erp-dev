...
if(isset($_SESSION['status'])){
    ...
    <div class="card">
        <div class="card-header">
                <h4 class="card-title"><?php //echo $this->lang->line('Add New Task') ?>View WhatsApp Campaign Details 
            </h4>
                                ...
                                <div class="tab-pane active show" id="tab1" role="tabpanel" aria-labelledby="base-tab1">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text"   placeholder="Campaign Name"
                                                   ...
                                                   id="campaign_name" value="<?php echo $campaign_details['campaignName']; ?>">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <input type="text"  readonly placeholder="Template"
                                                   ...
                                                   id="schedule_date" value="<?php echo $campaign_details['template']['name']; ?>">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <option value='<?php echo $list['id']; ?>' <?php if(in_array($list['id'],$includedListsArray)){ echo "selected"; } ?>><?php echo $list['name']; ?></option>
                                        <?php } } ?>
                                        </select>
