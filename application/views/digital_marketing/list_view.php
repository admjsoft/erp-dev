...
if(isset($_SESSION['status'])){
    ...
    <div class="card">
        <div class="card-header">
                <h4 class="card-title"><?php //echo $this->lang->line('Add New Task') ?>View List Details 
            </h4>
                            ...
                            <div class="tab-content px-1 pt-1">
                                <div class="tab-pane active show" id="tab1" role="tabpanel" aria-labelledby="base-tab1">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text"   placeholder="list Name"
                                                   ...
                                                   id="list_name" value="<?php if(isset($list_details['name'])){ echo $list_details['name']; }  ?>">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <option value='<?php echo $folder['id']; ?>' <?php if($folder['id'] == $list_details['folderId']){ echo "selected";} ?>><?php echo $folder['name']; ?></option>
                                        <?php } } ?>
                                        </select>
