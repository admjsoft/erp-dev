...
if(isset($_SESSION['status'])){
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"><?php echo $this->lang->line('View List Details') ?>
            </h4>
                        ...
                        <div class="card-body">
                            <div class="tab-content px-1 pt-1">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="list Name"
                                                ...
                                                id="list_name"
                                                value="<?php if(isset($list_details['name'])){ echo $list_details['name']; }  ?>">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control margin-bottom b_input required "
                                                ...
                                                <option value='<?php echo $folder['id']; ?>'
                                                    <?php if($folder['id'] == $list_details['folderId']){ echo "selected";} ?>>
                                                    <?php echo $folder['name']; ?></option>
                                                <?php } } ?>
                                            </select>
                                ...
                                <div id="mybutton">
                                    ...
                                    <input type="hidden" name="list_id" value="<?php echo $list_details['id']; ?>"
                                        id="list_id">
                                    <?php /* ?>
                ...
                if (data.status == '200') {
                    setTimeout(function() {
                        window.location.href =
                            "<?php echo site_url('digitalmarketing/lists') ?>";
