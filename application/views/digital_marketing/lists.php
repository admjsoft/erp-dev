<div class="content-body">
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"><?php echo $this->lang->line('Lists') ?><a
                    href="<?php echo base_url('digitalmarketing/list_create'); ?>"
                    class="btn btn-primary btn-sm rounded ml-2">
                    <?php echo $this->lang->line('Add New List'); ?></a></h4>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="no-sort">
                                ...
                                <a href="<?php echo base_url('digitalmarketing/list_edit/?' . http_build_query(array('id' => $list['id']))); ?>"
                                    style="display: inline-block; padding:6px; margin-left:1px;"
                                    class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo base_url('digitalmarketing/list_view/?' . http_build_query(array('id' => $list['id']))); ?>"
                                    style="display: inline-block; padding:6px; margin-left:1px;"
                                    class="btn btn-success btn-xs"><i class="fa fa-eye"></i></a>
                                <a href="<?php echo base_url('digitalmarketing/list_contacts/?' . http_build_query(array('id' => $list['id']))); ?>"
                                    style="display: inline-block; padding:6px; margin-left:1px;"
                                    class="btn btn-success btn-xs"><i class="fa fa-forward"></i></a>
                                <?php // } ?>
                                <a list_id="<?php echo $list['id']; ?>"
                                    style="display: inline-block; padding:6px; margin-left:1px;"
