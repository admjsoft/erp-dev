...
if(isset($_SESSION['status'])){
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"><?php echo $this->lang->line('Add Sms Campaign Details'); ?>
            </h4>
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Campaign Name"
                                                ...
                                                name="campaign_name" id="campaign_name" value="">
...
$(document).ready(function() {
    ...
    $(document).on('click', "#update_product_btn", function(e) {
        ...
        if (campaign_name != '' && sender_name != '' && schedule_date != '' && message_content != '' &&
            receipents != '') {
