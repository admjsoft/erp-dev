                ...
                <table id="th_vendors" class="table table-striped table-bordered zero-configuration ">
                    ...
                    <tbody>
                        ...
                        <?php if(!empty($campaigns['campaigns'])){ $c=1; foreach($campaigns['campaigns'] as $campaign){ ?>
                            ...
                            <td class="no-sort"><a href="<?php echo base_url('digitalmarketing/email_campaign_edit/?' . http_build_query(array('id' => $campaign['id']))); ?>" style="display: inline-block; padding:6px; margin-left:1px;" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
                            <a href="<?php echo base_url('digitalmarketing/email_campaign_edit/?' . http_build_query(array('id' => $campaign['id']))); ?>" style="display: inline-block; padding:6px; margin-left:1px;" class="btn btn-success btn-xs"><i class="fa fa-eye"></i></a>
...
<script type="text/javascript">
    $(document).ready(function () {
       ...
       var campaign_id = $(this).attr('campaign_id');
        ...
        url: "<?php echo site_url('digitalmarketing/email_campaign_delete') ?>",
        type: 'POST',
        dataType: 'json',
        data: {
