                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="no-sort">
                                ...
                                <a href="<?php echo base_url('digitalmarketing/whatsapp_campaign_edit/?' . http_build_query(array('id' => $campaign['id']))); ?>"
                                    style="display: inline-block; padding:6px; margin-left:1px;"
                                    class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo base_url('digitalmarketing/whatsapp_campaign_view/?' . http_build_query(array('id' => $campaign['id']))); ?>"
                                    style="display: inline-block; padding:6px; margin-left:1px;"
