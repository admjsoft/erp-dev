...
if(isset($_SESSION['status'])){
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"><?php echo $this->lang->line('Create Contact'); ?>
            </h4>
                            ...
                            <div class="tab-content px-1 pt-1">
                                <div class="tab-pane active show" id="tab1" role="tabpanel" aria-labelledby="base-tab1">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="first Name"
                                                ...
                                                id="first_name"
                                                value="<?php if(isset($contact_details['attributes']['FIRSTNAME'])){ echo $contact_details['attributes']['FIRSTNAME']; }  ?>">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="last Name"
                                                ...
                                                id="last_name"
                                                value="<?php if(isset($contact_details['attributes']['LASTNAME'])){  echo $contact_details['attributes']['LASTNAME']; } ?>">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="sms phone No with country code"
                                                ...
                                                id="last_name"
                                                value="<?php if(isset($contact_details['attributes']['SMS'])){  echo $contact_details['attributes']['SMS']; } ?>">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="whatsapp phone No with country code"
                                                ...
                                                id="whatsapp_no"
                                                value="<?php if(isset($contact_details['attributes']['WHATSAPP'])){ echo $contact_details['attributes']['WHATSAPP']; } ?>">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control margin-bottom b_input required "
                                                name="email_blacklist" id="email_blacklist">

                                                <option value='true'
                                                    <?php if($contact_details['emailBlacklisted'] == true){ echo "selected"; }?>>
                                                    yes</option>
                                                <option value='false'
                                                    <?php if($contact_details['emailBlacklisted'] == false){ echo "selected"; }?>>
                                                    no</option>
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control margin-bottom b_input required "
                                                name="sms_blacklist" id="sms_blacklist">

                                                <option value='true'
                                                    <?php if($contact_details['smsBlacklisted'] == true){ echo "selected"; }?>>
                                                    yes</option>
                                                <option value='false'
                                                    <?php if($contact_details['smsBlacklisted'] == false){ echo "selected"; }?>>
                                                    no</option>
                                        ...
                                        <div class="col-sm-8">
                                            <select multiple class="form-control margin-bottom b_input required "
                                                ...
                                                <option value='<?php echo $list['id']; ?>'
                                                    <?php if(in_array($list['id'],$contact_details['listIds'])){ echo "selected"; } ?>>
                ...
                if (data.status == '200') {
                    setTimeout(function() {
                        window.location.href =
                            "<?php echo site_url('digitalmarketing/sms_marketing_campaigns') ?>";
