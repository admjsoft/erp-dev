<div class="content-body">
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"><?php echo $this->lang->line('SMS Campaigns'); ?><a
                    href="<?php echo base_url('digitalmarketing/sms_campaign_create'); ?>"
                    class="btn btn-primary btn-sm rounded ml-2">
                    <?php echo $this->lang->line('Add New Sms Campaign'); ?></a></h4>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="no-sort">
                                ...
                                <a href="<?php echo base_url('digitalmarketing/sms_campaign_edit/?' . http_build_query(array('id' => $campaign['id']))); ?>"
                                    style="display: inline-block; padding:6px; margin-left:1px;"
                                    class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo base_url('digitalmarketing/sms_campaign_view/?' . http_build_query(array('id' => $campaign['id']))); ?>"
                                    style="display: inline-block; padding:6px; margin-left:1px;"
                                    class="btn btn-success btn-xs"><i class="fa fa-eye"></i></a>
                                <?php } ?>
                                <a campaign_id="<?php echo $campaign['id']; ?>"
                                    style="display: inline-block; padding:6px; margin-left:1px;"
