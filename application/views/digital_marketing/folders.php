                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="no-sort">
                                ...
                                <a href="<?php echo base_url('digitalmarketing/folder_edit/?' . http_build_query(array('id' => $folder['id']))); ?>"
                                    style="display: inline-block; padding:6px; margin-left:1px;"
                                    class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo base_url('digitalmarketing/folder_view/?' . http_build_query(array('id' => $folder['id']))); ?>"
                                    style="display: inline-block; padding:6px; margin-left:1px;"
                                    class="btn btn-success btn-xs"><i class="fa fa-eye"></i></a>
                                <a href="<?php echo base_url('digitalmarketing/folder_lists/?' . http_build_query(array('id' => $folder['id']))); ?>"
                                    style="display: inline-block; padding:6px; margin-left:1px;"
                                    class="btn btn-success btn-xs"><i class="fa fa-forward"></i></a>
                                <?php // } ?>
                                <a folder_id="<?php echo $folder['id']; ?>"
                                    style="display: inline-block; padding:6px; margin-left:1px;"
