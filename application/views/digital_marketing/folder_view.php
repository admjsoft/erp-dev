...
if(isset($_SESSION['status'])){
    ...
    <div class="card">
        <div class="card-header">
                <h4 class="card-title"><?php //echo $this->lang->line('Add New Task') ?>Edit Folder Details 
            </h4>
                        ...
                        <div class="card-body">
                            <div class="tab-content px-1 pt-1">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text"   placeholder="folder Name"
                                                   ...
                                                   id="folder_name" value="<?php if(isset($folder_details['name'])){ echo $folder_details['name']; }  ?>">
                                ...
                                <div id="mybutton">
                                    ...
                                    <input type="hidden" name="folder_id" value="<?php echo $folder_details['id']; ?>" id="folder_id">
                                    <?php /* ?>
                                    <input type="button" id="update_product_btn"
                                           class="btn btn-lg btn btn-primary margin-bottom round float-xs-right mr-2"
                                           value="<?php //echo $this->lang->line('Add customer') ?>Update Folder"
    ...
    $(document).on('click', "#update_product_btn", function (e) {
       ...
       var folder_id = $('#folder_id').val();
        ...
        success: function (data) {
            ...
            {
                setTimeout(function() {
                window.location.href = "<?php echo site_url('digitalmarketing/folders') ?>";
