...
if(isset($_SESSION['status'])){
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"><?php echo $this->lang->line('Edit Folder Details') ?>
            </h4>
                        ...
                        <div class="card-body">
                            <div class="tab-content px-1 pt-1">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="folder Name"
                                                ...
                                                id="folder_name"
                                                value="<?php if(isset($folder_details['name'])){ echo $folder_details['name']; }  ?>">
                                ...
                                <div id="mybutton">
                                    ...
                                    <input type="hidden" name="folder_id" value="<?php echo $folder_details['id']; ?>"
                                        id="folder_id">
                                    <?php /* ?>
