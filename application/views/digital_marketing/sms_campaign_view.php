...
if(isset($_SESSION['status'])){
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"><?php echo $this->lang->line('View Sms Campaign Details') ?>
            </h4>
                        ...
                        <div class="card-body">
                            <div class="tab-content px-1 pt-1">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea placeholder="Message Content"
                                                ...
                                                value=""><?php echo $campaign_details['content']; ?> </textarea>
                                        ...
                                        <div class="col-sm-8">
                                            <select multiple class="form-control margin-bottom b_input required "
                                                ...
                                                <option value='<?php echo $list['id']; ?>'
                                                    <?php if(in_array($list['id'],$idsArray)){ echo "selected"; } ?>>
                                ...
                                <div id="mybutton">
                                    ...
                                    <input type="hidden" name="vendor_id" value="<?php echo $campaign_details['id']; ?>"
                                        id="sms_campaign_id">
