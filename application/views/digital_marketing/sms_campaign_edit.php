...
if(isset($_SESSION['status'])){
    ...
    <div class="card">
        <div class="card-header">
                <h4 class="card-title"><?php //echo $this->lang->line('Add New Task') ?>Edit Sms Campaign Details 
            </h4>
                            ...
                            <div class="tab-content px-1 pt-1">
                                <div class="tab-pane active show" id="tab1" role="tabpanel" aria-labelledby="base-tab1">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text"   placeholder="Campaign Name"
                                                   ...
                                                   id="campaign_name" value="<?php echo $campaign_details['name']; ?>">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text"   placeholder="Sender Name"
                                                   ...
                                                   id="sender_name" value="<?php echo $campaign_details['sender']; ?>">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="datetime-local"   placeholder="Consumer Key"
                                                   ...
                                                   id="schedule_date" value="<?php echo $campaign_details['scheduledAt']; ?>">
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea   placeholder="Message Content"
                                                   ...
                                                   id="message_content" value=""><?php echo $campaign_details['content']; ?> </textarea>
                                    ...
                                    <div class="form-group row mt-1">
                                        ...
                                        <?php 
                                        $idsArray = array();
                                        foreach ($campaign_details['recipients']["lists"]as $c_list) {
                                            if (isset($c_list['id'])) {
                                                $idsArray[] = $c_list['id'];
                                            }
                                        } 
                                        ...
                                        <option value='<?php echo $list['id']; ?>' <?php if(in_array($list['id'],$idsArray)){ echo "selected"; } ?>><?php echo $list['name']; ?></option>
                                        <?php } } ?>
                                        </select>
