...
<script type="text/javascript">
	...
	var permit_expiry="permit_expiry";
        $('#trans_table').removeAttr('width').DataTable( {
            ...
            "ajax": {
                "url": "<?php echo site_url('employee/getfwmsEmployeesPermitExpired')?>",
                "type": "POST",
                'data': {'permit_expiry':permit_expiry,'<?=$this->security->get_csrf_token_name()?>': crsf_hash }
            },
