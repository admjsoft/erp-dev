...
<script type="text/javascript">
	...
	var passport_ninety_expiry="ninety";
        $('#trans_table').removeAttr('width').DataTable( {
            ...
            <?php datatable_lang();?>
			  'order': [],
            "ajax": {
                "url": "<?php echo site_url('employee/PassportExpiredInNinetyDays')?>",
                "type": "POST",
                'data': {'passport_ninety_expiry':passport_ninety_expiry,'<?=$this->security->get_csrf_token_name()?>': crsf_hash }
            },
