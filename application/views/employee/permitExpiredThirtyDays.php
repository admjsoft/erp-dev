...
<script type="text/javascript">
	...
	var permit_thirty_expiry="thirty";
        $('#trans_table').removeAttr('width').DataTable( {
            ...
            "ajax": {
                "url": "<?php echo site_url('employee/PermitExpiredInThirtyDays')?>",
                "type": "POST",
                'data': {'permit_thirty_expiry':permit_thirty_expiry,'<?=$this->security->get_csrf_token_name()?>': crsf_hash }
            },
