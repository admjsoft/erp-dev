...
<script type="text/javascript">
	...
	var passport_sixty_expiry="sixty";
        $('#trans_table').removeAttr('width').DataTable( {
            ...
            <?php datatable_lang();?>
			  'order': [],
            "ajax": {
                "url": "<?php echo site_url('employee/PassportExpiredInSixtyDays')?>",
                "type": "POST",
                'data': {'passport_sixty_expiry':passport_sixty_expiry,'<?=$this->security->get_csrf_token_name()?>': crsf_hash }
            },
