...
<script type="text/javascript">
	...
	var permit_active="permit_active";
        $('#trans_table').removeAttr('width').DataTable( {
            ...
            "ajax": {
                "url": "<?php echo site_url('employee/getfwmsEmployeesPermitActive')?>",
                "type": "POST",
                'data': {'permit_active':permit_active,'<?=$this->security->get_csrf_token_name()?>': crsf_hash }
            },
