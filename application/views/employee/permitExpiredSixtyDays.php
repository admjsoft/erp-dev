	...
	var permit_sixty_expiry="sixty";
        $('#trans_table').removeAttr('width').DataTable( {
            ...
            <?php datatable_lang();?>
			  'order': [],
            "ajax": {
                "url": "<?php echo site_url('employee/PermitExpiredInSixtyDays')?>",
                "type": "POST",
                'data': {'permit_sixty_expiry':permit_sixty_expiry,'<?=$this->security->get_csrf_token_name()?>': crsf_hash }
            },
