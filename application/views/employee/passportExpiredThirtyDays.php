...
<script type="text/javascript">
	...
	var passport_expiry="thirty";
        $('#trans_table').removeAttr('width').DataTable( {
            ...
            "ajax": {
                "url": "<?php echo site_url('employee/PassportExpiredInThirtyDays')?>",
                "type": "POST",
                'data': {'passport_thirty_expiry':passport_expiry,'<?=$this->security->get_csrf_token_name()?>': crsf_hash }
            },
