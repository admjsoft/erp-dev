...
unset($_SESSION['status']);unset($_SESSION['message']);
           ...
           <div id="notify" class="alert alert-success" style="display:none;">
            ...
            <div class="card-body">
                <form method="post" id="form" enctype="multipart/form-data" action="<?php echo base_url("customers/import") ?>" >
                    ...
                    <?php } ?>
						...
						<div class="row mb-1 ml-1">
                            <label for="cst" class="col-md-3"><?php echo $this->lang->line('Import') ?> <span style="color:red">*</span></label>
                                <div class="col-md3">
