<div class="content-body">
    ...
    <div class="card">
        <div class="card-header">
            <h4><?php echo $this->lang->line('Add Customer') ?></h4>
...
unset($_SESSION['status']);unset($_SESSION['message']);
            ...
            <div id="notify" class="alert alert-success" style="display:none;">
                ...
                <form method="post" id="form" enctype="multipart/form-data"
                    action="<?php echo base_url("customers/import") ?>">
                    ...
                    <div class="row mb-1 ml-1">
                        ...
                        <div class="col-md-6 text-right float-right">
                            ...
                            <a href="<?php echo base_url('customers/downloadCustomerTemplate'); ?>" id="downloadButton"
                                class="btn btn-primary btn-sm"
                                ><?php echo $this->lang->line('Download Customer Management Template') ?></a>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mt-2 text-center">
                        <div class="col-md-12 mx-auto text-center">
                            ...
                            <p class="text-center">
                                company name,customer name,customer email,customer phone no,address,city,region,country,customer type(domestic,foreign)</p>
                        </div>
                    </div>
                            ...
                            <div class="form-group row mt-2">
                                <div class="col-sm-4">
                                    <input type="submit" id="submit" class="btn btn-success btn-lg margin-bottom"
                                        value="Upload" data-loading-text="Adding...">
                                </div>
                            </div>
                        </form>
                    </div>
