                    ...
                    <div class="col-md-8">
                        <div id="mybutton">
                            ...
                            <div class="">
                               ...
                               <?php /* temprary hide  <a href="<?php echo base_url('customers/bulkpayment?id=' . $details['id']) ?>"
                            ...
                            <div id="accordionWrapa1" role="tablist" aria-multiselectable="true">
                                ...
                                <div id="heading6" class="card-header bg-grey bg-lighten-4 p-1 mt-2">
                                    <a data-toggle="collapse" href="#accordion6"
                                       ...
                                       class="card-title lead collapsed"  role="tabpanel">
                                        ...
                                        <div class="card-block">
                                            <table class="table table-striped">
                                                ...
                                                <?php foreach ($activity as $row) {
                                                    ...
                                                    echo '<tr><td>'
                                                        . amountExchange($row['col1'], 0, $this->aauth->get_user()->loc) .
                                                        '</td><td>'
                                                        . $row['col2'] .
                                                        '</td></tr>';
                                                } ?>
