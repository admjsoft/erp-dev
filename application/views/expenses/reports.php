...
<div class="content-body">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="status"><?php echo $this->lang->line('Claim Category'); ?></label>
                        <select class="form-control" id="task_status">
                            <option value=""><?php echo $this->lang->line('Select Category'); ?></option>
                            <option value="personal loan"><?php echo $this->lang->line('personal loan'); ?></option>
                            <option value="medical"><?php echo $this->lang->line('medical'); ?></option>
                            <option value="Emergency"><?php echo $this->lang->line('Emergency'); ?></option>
                            <option value="Gg"><?php echo $this->lang->line('Gg'); ?></option>
                        </select>
                    </div>
                </div>
                <div class="col-md-2">
    ...
    <div class="card">
        <div class="card-header">
            <h5><?php echo $this->lang->line('Claims') ?> <?php echo $this->lang->line('Reports'); ?></h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><?php echo $this->lang->line('delete this expense') ?><?php echo $this->lang->line('no Are you sure you want to delete this expense?'); ?></p>
                </div>
...
<form method="post" id="update_form" action="<?php base_url('expenses/update_i'); ?>">
    <div id="update_model" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><?php echo $this->lang->line('Status Update') ?>
                    </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body container-fluid">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" class="form-control" placeholder="Receipt Date" id="receipt_date"
                                disabled>
                        </div>
                        <div class="form-group col-sm-6">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <a href="#" class=" btn btn-blue form-control" target="_blank" id="doc"><span
                                    id="doct"><?php echo $this->lang->line('View Supporting Document') ?></span></a>
                        </div>
                        <div class="form-group col-sm-12">
                            <label for="remarks"><?php echo $this->lang->line("Admin's Remark") ?></label>
