...
<head>
    ...
    <title><?php echo $this->lang->line('Print Trans'); ?> #<?php echo $trans['id'] ?></title>
    ...
    <table>
        <tr>
            ...
            <td> <?php echo '<div class="col-xs-6 col-sm-6 col-md-6">
                    <p>' . $this->lang->line('amount') . ' : ' . amountExchange($trans['receipt_amount'], 0, $this->aauth->get_user()->loc) . ' </p><p>' . $this->lang->line('Tax') . 'Tax : ' . amountExchange($trans['tax_amount'], 0, $this->aauth->get_user()->loc) . ' </p>'; ?>
            </td>
        </tr>
    </table>
