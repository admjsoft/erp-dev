...
<div class="content-body">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="title">
                <?php echo $this->lang->line('Module') ?> <a href="<?php echo base_url('modules/customer_module_add') ?>"
            ...
            <div class="card-body">
                ...
                <form method="post" id="data_form" class="form-horizontal">
                    ...
                    <div class="form-group row mt-1">
                        ...
                        <label class="col-sm-2 col-form-label" for="name"><?php echo $this->lang->line('Customers') ?> <span
                                style="color:red">*</span></label>
                        <div class="col-sm-8">
                            <select name="role" id="role" class="form-control" onchange="getValues(this.value);"
                                style="width:50%" required>
                                <option value="">--<?php echo $this->lang->line('Select Customer'); ?>--</option>
                                <?php 										
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <label><input type="checkbox" name="sample" class="selectall" />
                                <?php echo $this->lang->line('Select all'); ?></label>
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="hidden" value="modules/update_customer_role_permissions" id="action-url">
        ...
        function getValues(val) {
            ...
            $.ajax({
                type: "POST",
                url: baseurl + 'modules/get_customer_module_permissions',
                data: {
                    customer_id: val
                },
                success: function(data) {
