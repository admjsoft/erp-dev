            ...
            <div class="card-body">
                ...
                <form method="post" id="data_form" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <label><input type="checkbox" name="sample" class="selectall" /> <?php echo $this->lang->line('Select all'); ?></label>
                            ...
                            function displaySidebar($items, $parentId = null, $checkedIds) {
                                ...
                                foreach ($items as $item) {
                                    if ($item->parent_id == $parentId) {
                                        echo '<li>';
                                        $isChecked = ($item->subscription_status == 1) ? 'checked' : '';
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="hidden" value="modules/update_subscription_permissions" id="action-url">
