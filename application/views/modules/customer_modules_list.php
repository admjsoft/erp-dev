    ...
    <div class="card">
        <div class="card-header">
            <h5 class="title"> <?php echo $this->lang->line('Add Module') ?> <a
                    href="<?php echo base_url('modules/customer_module_add') ?>" class="btn btn-primary btn-sm rounded ml-2">
                ...
                <table id="modules_table" class="table table-striped table-bordered zero-configuration">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url("modules/customer_module_edit?id=".$row['id']); ?>"
                                    class='btn btn-success btn-sm'><i
                                        class='fa fa-edit'></i><?php echo $this->lang->line('Edit'); ?></a>&nbsp; <a
                                    href='#' data-object-id='<?php echo $row['id']; ?>'
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" id="action-url" value="modules/customer_module_delete">
