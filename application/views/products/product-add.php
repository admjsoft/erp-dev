        ...
        <div class="card-body">
            ...
            <form method="post" id="data_form">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span
                                    class="input-group-text justify-content-center"><?php echo $this->config->item('currency') ?></span>
                            </div>

                            <input type="text" name="product_price" class="form-control required" placeholder="0.00"
                ...
                <div class="form-group row">
                    ...
                    <label
                        class="col-sm-2 col-form-label"><?php echo $this->lang->line('Purchase Order') . $this->lang->line('Price') ?></label>
                    ...
                    <div class="col-sm-6">
                        <div class="input-group">
                            ...
                            <input type="text" name="fproduct_price" class="form-control" placeholder="0.00"
                                aria-describedby="sizing-addon1" onkeypress="return isNumber(event)">
                        </div>
                    </div>
                </div>
                <hr>
                ...
                <div id="accordionWrapa1" role="tablist" aria-multiselectable="true">
                    ...
                    <div id="coupon4" class="card-header">
                        <a data-toggle="collapse" data-parent="#accordionWrapa1" href="#accordion41"
                            aria-expanded="true" aria-controls="accordion41" class="card-title lead collapsed"><i
                                class="fa fa-plus-circle"></i>
                            <?php echo $this->lang->line('Products') . ' ' . $this->lang->line('Variations') ?></a>
                    </div>
                    <div id="accordion41" role="tabpanel" aria-labelledby="coupon4" class="card-collapse collapse"
                        aria-expanded="false" style="height: 0px;">
                        <div class="row p-1">
                            <div class="col">
                                <button
                                    class="btn btn-blue tr_clone_add"><?php echo $this->lang->line('add_row') ?></button>
                ...
                <div id="accordionWrapa2" role="tablist" aria-multiselectable="true">
                    ...
                    <div id="accordion42" role="tabpanel" aria-labelledby="coupon5" class="card-collapse collapse"
                        aria-expanded="false" style="height: 0px;">
                        <div class="row p-1">
                            <div class="col">
