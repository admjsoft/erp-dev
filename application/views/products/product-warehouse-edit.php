...
unset($_SESSION['status']);unset($_SESSION['message']);
            ...
            <div class="card-body">
                <form method="post" id="data_form" enctype="multipart/form-data"
                    action="<?php //echo base_url("employee/updaterole") ?>">
                    ...
                    <div class="row mb-1 ml-1">
                        ...
                        <div class="col-md3">
                            <input type="text" class="form-control margin-bottom  required" id="product_cat_name" name="product_cat_name"
                    ...
                    <div class="row mb-1 ml-1">
                        ...
                        <div class="col-md3">
                            <input type="text" name="product_cat_desc" id="product_cat_desc" class="form-control required"
                    ...
                    <div class="row mb-1 ml-1">
                        ...
                        <div class="col-md3">
                            <select name="lid" id="lid" class="form-control">
                                <option value='<?php echo $warehouse['loc'] ?>'>
                    ...
                    <div class="form-group row mt-2">
                        <div class="col-sm-4">
                            <input type="submit" id="submit-data" class="btn btn-success margin-bottom" value="Update"
                                data-loading-text="Updating...">
                            <input type="hidden" value="<?php echo $warehouse['id'] ?>" id="catid" name="catid">
