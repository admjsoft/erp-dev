    ...
    <div class="card card-block">
        ...
        <div class="card-body">
            <div class="card-header">
                <h4 class="card-title"><?php echo $this->lang->line('Detailed Stock Balance') ?> </div>
            ...
            <table class="table table-striped table-bordered zero-configuration"
                ...
                <thead >
                    <tr>
                        ...
                        <th><?php echo $this->lang->line('Sold Qty'); ?></th>
                        <th><?php echo $this->lang->line('Remining Qty'); ?></th>
                ...
                <tbody id="expiry-products-modal-body-content-with-sales">
                    ...
                    <td><a href="#" class="get_delivery_order_sale_invoices" do_id="<?php echo $product['delivery_order_id']; ?>" p_id="<?php echo $product['pid']; ?>"> <?php echo ((int)$product['total_used_qty']); ?></a></td>
            ...
            <div class="modal-dialog modal-xl">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header" style="background-color:#B68DB8; width=100%">
                        <h4 class="modal-title"><?php echo $this->lang->line('Invoices by Batches') ?></h4>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: '<?php echo base_url('products/get_detailed_stock_balance') ?>',
            data: {
                cat_id: cat_id,
