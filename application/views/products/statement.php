...
<div id="c_body"></div>
                    ...
                    <div class="row ">
                        <div class="col-md-12 m-1">
                            <form action="<?php echo base_url() ?>products/report_product" method="post" role="form">
                                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
                                       value="<?php echo $this->security->get_csrf_hash(); ?>">
                                <input name="id" type="hidden" value="<?php echo $product['pid'] ?>">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <select name="r_type" class="form-control">
                                            ...
                                            <option value='3'><?php echo $this->lang->line('Stock') . ' ' . $this->lang->line('Edit') ?></option>
                                        </select>
