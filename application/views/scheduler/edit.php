    ...
    unset($_SESSION['status']);unset($_SESSION['message']);
            ...
            <div class="card-body">
                <form method="post" id="form" enctype="multipart/form-data"
                    action="<?php echo base_url("scheduler/update") ?>">
                    ...
                    <div id="scheduleyes" style="display:block;">
                        <div class="row mb-1 ml-1">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="days" id="days" class="form-control" style="width:200px;">
                                    ...
                                    <option value="90" <?php if($schedule->days == "90"){ echo "selected"; } ?>>90 <?php echo $this->lang->line("Days"); ?>
                                    </option>
                                    <option value="180" <?php if($schedule->days == "180"){ echo "selected"; } ?>>180 <?php echo $this->lang->line("Days"); ?>
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="row mb-1 ml-1">
                            ...
                            <select id="hourSelect" name="hours">
                                <?php for ($hour = 0; $hour < 24; $hour++) { ?>
                                    <option value="<?php echo sprintf("%02d", $hour); ?>" <?php if($schedule->hours == $hour){ echo "selected"; } ?>><?php echo sprintf("%02d", $hour); ?></option>
                                <?php } ?>
                            </select>

                            <select id="minuteSelect" name="minutes">
                                <?php for ($minute = 0; $minute < 60; $minute += 30) { ?>
                                    <option value="<?php echo sprintf("%02d", $minute); ?>" <?php if($schedule->minutes == $minute){ echo "selected"; } ?>><?php echo sprintf("%02d", $minute); ?></option>
                                <?php } ?>
                            </select>
                            </div>
                                ...
                                <select class="form-control" name="module" id="module" style="width:200px;">
                                    ...
                                    <?php
                                        foreach ($modules as $module) {
                                            ?>
                                    <option value="<?php echo $module['id']; ?>" <?php if($schedule->module == $module['id']){ echo "selected"; } ?>><?php echo $module['name']; ?></option>
                                    <?php
                                        }?>
                                </select>
                            </div>
                        ...
                        <div class="row mb-1 ml-1">
                            <label for="cst" class="col-md-3"><?php echo $this->lang->line('Email To') ?><span
                                    style="color:red">*</span></label>
                            <div class="col-md-3">
                                <?php $emailers = explode(',',$schedule->email_to); ?>
                                <select class="form-multi-select form-control" name="email_to[]" id="email_to" multiple
                                    data-coreui-search="true" style="width:200px">
                                    <option value="1" <?php if(in_array("1",$emailers)){ echo "selected"; } ?>>Admin</option>
                                    <option value="2" <?php if(in_array("2",$emailers)){ echo "selected"; } ?>>Client</option>
                                    <option value="3" <?php if(in_array("3",$emailers)){ echo "selected"; } ?>>Employee</option>
                                </select>
                            </div>
                        ...
                        <div class="row mb-1 ml-1">
                            <label for="cst" class="col-md-3"><?php echo $this->lang->line('Scheduler For') ?><span
                                    style="color:red">*</span></label>
                            <div class="col-md-3">
                            <?php $scheduled_modules = explode(',',$schedule->scheduler_on); ?>
                                <select class="form-multi-select form-control" name="schedule_on[]" id="schedule_on"
                                    ...
                                    <?php if(!empty($sub_modules)){ foreach($sub_modules as $s_module){ ?>
                                        <option value="<?php echo $s_module['Id']; ?>" <?php if(in_array($s_module['Id'],$scheduled_modules)){ echo "selected"; } ?>><?php echo $s_module['Name']; ?></option>
                    ...
                    <div class="form-group row mt-2">
                        <div class="col-sm-4">
                            <input type="hidden" id="schedule_id" value="<?php echo $schedule->id; ?>" name="schedule_id" />
                            <input type="submit" id="submit" class="btn btn-success btn-lg margin-bottom"
                                value="<?php echo $this->lang->line('Update Schdeule') ?>" data-loading-text="Adding...">
                        </div>
                    </div>
                </form>
            </div>
