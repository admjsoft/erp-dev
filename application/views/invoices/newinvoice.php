           ...
           <script src="https://cdn.jsdelivr.net/npm/@tinymce/tinymce-jquery@1/dist/tinymce-jquery.min.js"></script>
            ...
            <div class="row mr-2">
                    ...
                    <div class="col-12 text-right mr-">
                        <!-- Small Button -->
                        <a href="<?php echo base_url('invoices'); ?>"> <button type="button" class="btn btn-sm btn-primary"><?php echo $this->lang->line('List'); ?> </button></a>
                    </div>
                </div>
                <form method="post" id="data_form" onSubmit="tinyMCE.triggerSave()">
                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <div id="customer">
                                    ...
                                    <div class="clientinfo">
                                        ...
                                        <div id="customer_phone"><?php echo is_array($cust_details)?'Phone: <strong>'.$cust_details['phone'].'</strong>':'';?><br/><?php echo is_array($cust_details)?'Email: <strong>'.$cust_details['email'].'</strong>':'';?></div>
                                    </div>
                                    <hr>
                    ...
                    <input type="hidden" value="<?php echo is_array($cust_details)?$cust_details['discount_c']:'0';?>" id="custom_discount">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" placeholder="Phone"
                                           class="form-control margin-bottom" pattern="[0-9]*" inputmode="numeric" name="phone" id="mcustomer_phone">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label"
