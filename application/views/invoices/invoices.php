    ...
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"><?php echo $this->lang->line('Manage Invoices') ?> <a
                    href="<?php echo base_url('invoices/create') ?>" class="btn btn-primary btn-sm rounded ml-2">
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                <div class="row justify-content-end">
                    ...
                    <div class="col-md-1">
                        <input type="button" name="search" id="search" value="<?php echo $this->lang->line('Search') ?>"
