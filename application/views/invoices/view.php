                ...
                <div class="row">
                    ...
                    <div class="">
                        ...
                        <div class="title-action">
                            ...
                            <?php /* ?><a href="<?php echo 'edit?id=' . $invoice['iid']; ?>"
                                class="btn btn-warning mb-1"><i class="fa fa-pencil"></i>
                                <?php echo $this->lang->line('Edit Invoice') ?></a>
                            <?php */ ?>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <span style="color:red">Refer Administrator To Purchase Sms Credit
                                                </span>
                                            </div>
                            ...
                            <a href="<?php echo $link; ?>" class="btn btn-blue-grey mb-1"><i class="fa fa-globe"></i>
    ...
    $('#fileupload').fileupload({
            ...
            formData: {
                ...
                $.each(data.result.files, function(index, file) {
                    $('#files').append(
                        '<tr><td><a data-url="<?php echo base_url() ?>invoices/file_handling?op=delete&name=' +
                        file.name +
                        ...
                        <div class="col">
                            <fieldset class="form-group position-relative has-icon-left">
                                <input type="text" class="form-control required" placeholder="Billing Date"
                                    name="paydate" data-toggle="datepicker">
                                <div class="form-control-position">
            ...
            <div class="modal-body" id="emailbody" style="display: none;">
                <form id="sendbill">
                    ...
                    <input type="hidden" class="form-control" id="invoiceid" name="tid"
                        value="<?php echo $invoice['iid'] ?>">
                    <input type="hidden" class="form-control" id="emailtype" value=""><input type="hidden"
                        class="form-control" name="attach" value="true">
...
<div id="pop_model" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h6 style="text-align: right; margin-top:5px;margin-right:5px;">
                    <?php echo "Current Status : "; //$this->lang->line('Change Status'); ?>
                    <?php echo ucfirst($invoice['status']); ?> </h6>
                        ...
                        <div class="col mb-1"><label for="pmethod"><?php echo $this->lang->line('Mark As') ?></label>
                            <select id="invoice_status_dd" name="status" class="form-control "
                                ...
                                <option value="due" <?php if($invoice['status'] == 'due'){ echo "selected"; } ?>>
                                    <?php echo $this->lang->line('Due'); ?></option>
                                <option value="partial"
                                    <?php if($invoice['status'] == 'partial'){ echo "selected"; } ?>>
                                    <?php echo $this->lang->line('Partial'); ?></option>
                                <option value="paid" <?php if($invoice['status'] == 'paid'){ echo "selected"; } ?>>
                                    <?php echo $this->lang->line('Paid'); ?></option>
                                <?php */ ?>
...
submitButton.addEventListener('click', function(e) {
    ...
    if (status == 'paid') {
        const PaidConfirmation = confirm(
            "Are you sure want to change status? Once status is paid, cant be changed");
        if (PaidConfirmation) {
            myForm.submit(); // Submit the form
        } else {
            e.preventDefault();
