    ...
    return {
        init: function() {
            (i = document.querySelector("#kt_modal_new_target")) && (o = new bootstrap.Modal(i),
             ...
             new Tagify(a.querySelector('[name="materials"]'), {
                whitelist: ["Cement", "Iron rods", "Bricks", "Pipers", "Sand"],
                maxTags: 5,
                dropdown: {
                    maxItems: 10,
                    enabled: 0,
            ...
            new Tagify(a.querySelector('[name="tools"]'), {
                whitelist: ["9mm Screws", "3mm Screws", "Drilling kit", "Gums", "Pins"],
                maxTags: 5,
                dropdown: {
                    maxItems: 10,
                    enabled: 0,
