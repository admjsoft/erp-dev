...
class User extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('customers_model', 'user_customers');
    ...
    public function auth_user($page = '')
    {
        ...
        if (empty($return)) {
            ...
            if ($return == 'not_varified') {
                ...
                $data=$this->user_customers->mydetails($this->User_model->auth_user()[0]->cid);
        ...
        if ($id != '') {
            ...
            if ($this->input->post('user_type') != 'admin') {
                ...
                if ($this->form_validation->run()) {
                    ...
                    //in customer
                    $cid = $this->User_model->insertRow('gtg_customers', $zdata1);
    ...
    public function update_address($id = '')
    {
        ...
        $this->User_model->updateRow('gtg_customers', 'id', $id, $data);
