...
// category save
    ...
    public function expenseslist()
    {
        ...
        foreach ($list as $prd) {
            ...
            $temp= '<a  href="#" data-object-id="' . $pid . '" class="btn btn-primary btn-sm update-object"><span class="fa fa-eye"></span>  ' . $this->lang->line('View') . '</a> &nbsp; &nbsp;</br><a  href="#" data-object-id="' . $pid . '" class="btn btn-danger btn-sm delete-object"><span class="fa fa-trash"></span></a>';
            if($prd->status==1){
                $row[] = "Approved";
