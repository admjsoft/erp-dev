...
<head>
    ...
    <link rel="apple-touch-icon" sizes="60x60"
        href="<?php echo assets_url(); ?>crm-assets/images/ico/apple-icon-60.png">
    <link rel="apple-touch-icon" sizes="76x76"
        href="<?php echo assets_url(); ?>crm-assets/images/ico/apple-icon-76.png">
    <link rel="apple-touch-icon" sizes="120x120"
        href="<?php echo assets_url(); ?>crm-assets/images/ico/apple-icon-120.png">
    <link rel="apple-touch-icon" sizes="152x152"
        href="<?php echo assets_url(); ?>crm-assets/images/ico/apple-icon-152.png">
    ...
    <!-- BEGIN ROBUST CSS-->
    <link rel="stylesheet" type="text/css"
        href="<?php echo assets_url(); ?>crm-assets/css<?= LTR ?>/bootstrap-extended.css">
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo assets_url(); ?>crm-assets/css/core/colors/palette-gradient.css">
    ...
    <script src="<?php echo assets_url(); ?>crm-assets/js/core/libraries/bootstrap.min.js" type="text/javascript">
    </script>
...
<body data-open="click" data-menu="vertical-menu" data-col="2-columns"
        ...
        <div class="navbar-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item custom-size"><a href="<?php echo base_url() ?>"
            ...
            <div class="navbar-container content container-fluid">
                <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
                    <ul class="nav navbar-nav">
                        <li class="nav-item hidden-sm-down ft-menu"><a
                                class="nav-link nav-menu-main menu-toggle hidden-xs ft-menu"><i
                        ...
                        <li class="dropdown dropdown-user nav-item">
                            ...
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link">
                                <span class="avatar avatar-online">
                                    <img src="<?php echo assets_url(); ?><?php echo isset($user_data[0]->profile_pic) ? "../userfiles/customers/".$user_data[0]->profile_pic : 'crm-assets/images/user.png'; ?>"
                                        alt="avatar">
                                    <i></i></span><?php echo $this->session->userdata('login_name'); ?></a>
                            <div class="dropdown-menu dropdown-menu-right"><a
                                    href="<?php echo base_url(); ?>user/profile" class="dropdown-item"><i
    ...
    $customer_id = $this->session->userdata('user_details')[0]->cid;
    $this->db->select('customer_sidebaritems.*');
    $this->db->from('customer_sidebaritems');
    $this->db->join('customer_sidebaritems_permissions', 'customer_sidebaritems.id = customer_sidebaritems_permissions.module_id AND customer_sidebaritems_permissions.customer_id = ' . $customer_id, 'left');
    $this->db->where('customer_sidebaritems_permissions.module_id IS NULL');
    $query = $this->db->get();
    //$result = $query->result();

    $sidebar_items = $query->result_array();
        ...
        <div class="main-menu-content">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main mt-2">
                ...
                <?php  if(!empty($sidebar_items)){
                    foreach($sidebar_items as $s_item){ ?>
                <li class="nav-item <?php //if ($this->uri->segment(1) == "invoices") { echo 'active';} ?>">
                    <a href="<?php echo base_url($s_item['url']); ?>"> <i class="<?php echo $s_item['icon']; ?>"></i><span
                            class="menu-title"> <?php echo $s_item['title']; ?> </span></a>
                </li>
                <?php 
                    }
                }  ?>
                ...
                echo 'active';
                    ...
                    <a href="<?php echo base_url(); ?>invoices/peppol_invoices/"> <i class="icon-file-text"></i><span
                            class="menu-title"> <?php echo "Peppol Invoices"; //$this->lang->line('Pay Bill'); ?>
                        </span></a>
                </li>
                <?php /* temprary hide
            <li class="nav-item <?php if ($this->uri->segment(1) == "rec_invoices") {
                ...
                <a href="<?php echo base_url(); ?>subscriptions/"> <i class="icon-android-calendar"></i><span
                        class="menu-title"> <?php echo $this->lang->line('Subscriptions'); ?> </span></a>
                </li> */ ?>
...
<?php /* ?>
                ...
                echo 'active';
                    ...
                    <a href="<?php echo base_url(); ?>quote/"> <i class="icon-file"></i><span class="menu-title">
                            <?php echo $this->lang->line('Quotes'); ?> </span></a>
                </li>
            ...
            <li class="nav-item <?php if($this->uri->segment(1) == "projects") echo "active"; ?>">
                ...
                */ ?>
                ...
                echo 'active';
                    ...
                    <a href="<?php echo base_url(); ?>employee/fwmsemployees"> <i class="icon-user1"></i><span
                            class="menu-title">
                ...
                echo 'active';
                    ...
                    <a href="<?php echo base_url(); ?>employee/fwmsreport"> <i class="icon-user1"></i><span
                            class="menu-title">
                ...
                echo 'active';
                    ...
                    <a href="<?php echo base_url(); ?>user/profile"> <i class="icon-user1"></i><span class="menu-title">
                            <?php echo $this->lang->line('Profile') ?> </span></a>
                </li>
                <li class="nav-item <?php if ($this->uri->segment(1) == "address") {
                echo 'active';
            } ?>">
                    <a href="<?php echo base_url(); ?>user/address"> <i class="icon-address-book"></i><span
                            class="menu-title"> <?php echo $this->lang->line('Address') ?> </span></a>
                </li>
                <?php /* temprary hide
